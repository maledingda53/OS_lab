...
ffffffffc020003a:	0f250513          	addi	a0,a0,242 # ffffffffc02a1128 <edata>
ffffffffc020003e:	000ac617          	auipc	a2,0xac
ffffffffc0200042:	67260613          	addi	a2,a2,1650 # ffffffffc02ac6b0 <end>
kern_init(void) {
...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	5c0060ef          	jal	ra,ffffffffc020660e <memset>
...
ffffffffc020007e:	521050ef          	jal	ra,ffffffffc0205d9e <proc_init>
...
ffffffffc0200092:	659050ef          	jal	ra,ffffffffc0205eea <cpu_idle>
...
ffffffffc02000b2:	5b250513          	addi	a0,a0,1458 # ffffffffc0206660 <etext+0x28>
...
ffffffffc02000c8:	064b8b93          	addi	s7,s7,100 # ffffffffc02a1128 <edata>
        else if (c >= ' ' && i < BUFSIZE - 1) {
...
ffffffffc020012a:	00250513          	addi	a0,a0,2 # ffffffffc02a1128 <edata>
...
ffffffffc0200180:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200182:	062060ef          	jal	ra,ffffffffc02061e4 <vprintfmt>
    return cnt;
}
...
ffffffffc02001b4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001b6:	02e060ef          	jal	ra,ffffffffc02061e4 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020021c:	48050513          	addi	a0,a0,1152 # ffffffffc0206698 <etext+0x60>
void print_kerninfo(void) {
...
ffffffffc0200232:	48a50513          	addi	a0,a0,1162 # ffffffffc02066b8 <etext+0x80>
ffffffffc0200236:	f59ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020023a:	00006597          	auipc	a1,0x6
ffffffffc020023e:	3fe58593          	addi	a1,a1,1022 # ffffffffc0206638 <etext>
ffffffffc0200242:	00006517          	auipc	a0,0x6
ffffffffc0200246:	49650513          	addi	a0,a0,1174 # ffffffffc02066d8 <etext+0xa0>
ffffffffc020024a:	f45ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  edata  0x%08x (virtual)\n", edata);
ffffffffc020024e:	000a1597          	auipc	a1,0xa1
ffffffffc0200252:	eda58593          	addi	a1,a1,-294 # ffffffffc02a1128 <edata>
ffffffffc0200256:	00006517          	auipc	a0,0x6
ffffffffc020025a:	4a250513          	addi	a0,a0,1186 # ffffffffc02066f8 <etext+0xc0>
ffffffffc020025e:	f31ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc0200262:	000ac597          	auipc	a1,0xac
ffffffffc0200266:	44e58593          	addi	a1,a1,1102 # ffffffffc02ac6b0 <end>
ffffffffc020026a:	00006517          	auipc	a0,0x6
ffffffffc020026e:	4ae50513          	addi	a0,a0,1198 # ffffffffc0206718 <etext+0xe0>
ffffffffc0200272:	f1dff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc0200276:	000ad597          	auipc	a1,0xad
ffffffffc020027a:	83958593          	addi	a1,a1,-1991 # ffffffffc02acaaf <end+0x3ff>
...
ffffffffc020029c:	4a050513          	addi	a0,a0,1184 # ffffffffc0206738 <etext+0x100>
}
...
ffffffffc02002ac:	3c060613          	addi	a2,a2,960 # ffffffffc0206668 <etext+0x30>
ffffffffc02002b0:	04d00593          	li	a1,77
ffffffffc02002b4:	00006517          	auipc	a0,0x6
ffffffffc02002b8:	3cc50513          	addi	a0,a0,972 # ffffffffc0206680 <etext+0x48>
void print_stackframe(void) {
...
ffffffffc02003c0:	230060ef          	jal	ra,ffffffffc02065f0 <strchr>
...
ffffffffc02003e4:	1e2060ef          	jal	ra,ffffffffc02065c6 <strcmp>
...
ffffffffc02003f8:	1ce060ef          	jal	ra,ffffffffc02065c6 <strcmp>
...
ffffffffc020045e:	192060ef          	jal	ra,ffffffffc02065f0 <strchr>
...
ffffffffc0200488:	0a430313          	addi	t1,t1,164 # ffffffffc02ac528 <is_panic>
...
ffffffffc02004ac:	08f73023          	sd	a5,128(a4) # ffffffffc02ac528 <is_panic>
...
ffffffffc020053c:	fef73c23          	sd	a5,-8(a4) # ffffffffc02ac530 <timebase>
...
ffffffffc0200564:	0207b023          	sd	zero,32(a5) # ffffffffc02ac580 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc0200574:	fc078793          	addi	a5,a5,-64 # ffffffffc02ac530 <timebase>
...
ffffffffc020060e:	f1e78793          	addi	a5,a5,-226 # ffffffffc02a1528 <ide>
...
ffffffffc0200620:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200622:	7ff050ef          	jal	ra,ffffffffc0206620 <memcpy>
    return 0;
}
...
ffffffffc0200638:	ef450513          	addi	a0,a0,-268 # ffffffffc02a1528 <ide>
                   size_t nsecs) {
...
ffffffffc0200646:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200648:	7d9050ef          	jal	ra,ffffffffc0206620 <memcpy>
    return 0;
}
...
ffffffffc02008b4:	de848493          	addi	s1,s1,-536 # ffffffffc02ac698 <check_mm_struct>
...
ffffffffc02008fa:	c6a78793          	addi	a5,a5,-918 # ffffffffc02ac560 <current>
ffffffffc02008fe:	6398                	ld	a4,0(a5)
ffffffffc0200900:	000ac797          	auipc	a5,0xac
ffffffffc0200904:	c6878793          	addi	a5,a5,-920 # ffffffffc02ac568 <idleproc>
...
ffffffffc020093a:	c2a78793          	addi	a5,a5,-982 # ffffffffc02ac560 <current>
...
ffffffffc0200a36:	b4e78793          	addi	a5,a5,-1202 # ffffffffc02ac580 <ticks>
...
ffffffffc0200a4a:	b2f6bd23          	sd	a5,-1222(a3) # ffffffffc02ac580 <ticks>
ffffffffc0200a4e:	eb09                	bnez	a4,ffffffffc0200a60 <interrupt_handler+0x94>
ffffffffc0200a50:	000ac797          	auipc	a5,0xac
ffffffffc0200a54:	b1078793          	addi	a5,a5,-1264 # ffffffffc02ac560 <current>
...
ffffffffc0200b76:	9ee78793          	addi	a5,a5,-1554 # ffffffffc02ac560 <current>
...
ffffffffc0200c58:	90c40413          	addi	s0,s0,-1780 # ffffffffc02ac560 <current>
...
ffffffffc0200cd6:	70e040ef          	jal	ra,ffffffffc02053e4 <do_exit>
...
ffffffffc0200e5a:	73278793          	addi	a5,a5,1842 # ffffffffc02ac588 <free_area>
...
ffffffffc0200e6c:	73056503          	lwu	a0,1840(a0) # ffffffffc02ac598 <free_area+0x10>
...
ffffffffc0200e7a:	71290913          	addi	s2,s2,1810 # ffffffffc02ac588 <free_area>
...
ffffffffc0200f16:	6a678793          	addi	a5,a5,1702 # ffffffffc02ac5b8 <pages>
...
ffffffffc0200f2a:	62270713          	addi	a4,a4,1570 # ffffffffc02ac548 <npage>
...
ffffffffc0200f6e:	6327b323          	sd	s2,1574(a5) # ffffffffc02ac590 <free_area+0x8>
ffffffffc0200f72:	000ab797          	auipc	a5,0xab
ffffffffc0200f76:	6127bb23          	sd	s2,1558(a5) # ffffffffc02ac588 <free_area>
    nr_free = 0;
ffffffffc0200f7a:	000ab797          	auipc	a5,0xab
ffffffffc0200f7e:	6007af23          	sw	zero,1566(a5) # ffffffffc02ac598 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc020100e:	5787bf23          	sd	s8,1406(a5) # ffffffffc02ac588 <free_area>
ffffffffc0201012:	000ab797          	auipc	a5,0xab
ffffffffc0201016:	5777bf23          	sd	s7,1406(a5) # ffffffffc02ac590 <free_area+0x8>
    nr_free = nr_free_store;
ffffffffc020101a:	000ab797          	auipc	a5,0xab
ffffffffc020101e:	5767af23          	sw	s6,1406(a5) # ffffffffc02ac598 <free_area+0x10>
    free_page(p);
...
ffffffffc020105a:	5327b923          	sd	s2,1330(a5) # ffffffffc02ac588 <free_area>
ffffffffc020105e:	000ab797          	auipc	a5,0xab
ffffffffc0201062:	5327b923          	sd	s2,1330(a5) # ffffffffc02ac590 <free_area+0x8>
    assert(alloc_page() == NULL);
...
ffffffffc020107e:	5007af23          	sw	zero,1310(a5) # ffffffffc02ac598 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc020114e:	4577a723          	sw	s7,1102(a5) # ffffffffc02ac598 <free_area+0x10>
    free_list = free_list_store;
ffffffffc0201152:	000ab797          	auipc	a5,0xab
ffffffffc0201156:	4367bb23          	sd	s6,1078(a5) # ffffffffc02ac588 <free_area>
ffffffffc020115a:	000ab797          	auipc	a5,0xab
ffffffffc020115e:	4357bb23          	sd	s5,1078(a5) # ffffffffc02ac590 <free_area+0x8>
    free_pages(p0, 5);
...
ffffffffc020169e:	eee68693          	addi	a3,a3,-274 # ffffffffc02ac588 <free_area>
...
ffffffffc02016ac:	eeb72823          	sw	a1,-272(a4) # ffffffffc02ac598 <free_area+0x10>
...
ffffffffc02016dc:	eab83823          	sd	a1,-336(a6) # ffffffffc02ac588 <free_area>
...
ffffffffc02017ea:	da258593          	addi	a1,a1,-606 # ffffffffc02ac588 <free_area>
...
ffffffffc020186c:	d3072823          	sw	a6,-720(a4) # ffffffffc02ac598 <free_area+0x10>
    __op_bit(and, __NOT, nr, ((volatile unsigned long *)addr));
...
ffffffffc02018e4:	ca868693          	addi	a3,a3,-856 # ffffffffc02ac588 <free_area>
...
ffffffffc02018f2:	cab72523          	sw	a1,-854(a4) # ffffffffc02ac598 <free_area+0x10>
    if (list_empty(&free_list)) {
...
ffffffffc0201922:	c6b73523          	sd	a1,-918(a4) # ffffffffc02ac588 <free_area>
    __list_add(elm, listelm->prev, listelm);
...
ffffffffc02019b6:	76678793          	addi	a5,a5,1894 # ffffffffc02a1118 <slobfree>
...
ffffffffc02019fa:	72f73123          	sd	a5,1826(a4) # ffffffffc02a1118 <slobfree>
    if (flag) {
...
ffffffffc0201a24:	6f878793          	addi	a5,a5,1784 # ffffffffc02a1118 <slobfree>
...
ffffffffc0201a6c:	6af73823          	sd	a5,1712(a4) # ffffffffc02a1118 <slobfree>
    if (flag) {
...
ffffffffc0201ace:	aee78793          	addi	a5,a5,-1298 # ffffffffc02ac5b8 <pages>
...
ffffffffc0201ae0:	a6c70713          	addi	a4,a4,-1428 # ffffffffc02ac548 <npage>
    return page - pages + nbase;
...
ffffffffc0201b00:	aac78793          	addi	a5,a5,-1364 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc0201b54:	5c848493          	addi	s1,s1,1480 # ffffffffc02a1118 <slobfree>
...
ffffffffc0201bb2:	56f73523          	sd	a5,1386(a4) # ffffffffc02a1118 <slobfree>
    if (flag) {
...
ffffffffc0201bec:	52f73823          	sd	a5,1328(a4) # ffffffffc02a1118 <slobfree>
    if (flag) {
...
ffffffffc0201ca2:	89a78793          	addi	a5,a5,-1894 # ffffffffc02ac538 <bigblocks>
ffffffffc0201ca6:	639c                	ld	a5,0(a5)
		bigblocks = bb;
ffffffffc0201ca8:	000ab717          	auipc	a4,0xab
ffffffffc0201cac:	88973823          	sd	s1,-1904(a4) # ffffffffc02ac538 <bigblocks>
		bb->next = bigblocks;
...
ffffffffc0201ce4:	85878793          	addi	a5,a5,-1960 # ffffffffc02ac538 <bigblocks>
ffffffffc0201ce8:	639c                	ld	a5,0(a5)
		bigblocks = bb;
ffffffffc0201cea:	000ab717          	auipc	a4,0xab
ffffffffc0201cee:	84973723          	sd	s1,-1970(a4) # ffffffffc02ac538 <bigblocks>
		bb->next = bigblocks;
...
ffffffffc0201d30:	80c78793          	addi	a5,a5,-2036 # ffffffffc02ac538 <bigblocks>
...
ffffffffc0201d78:	83478793          	addi	a5,a5,-1996 # ffffffffc02ac5a8 <va_pa_offset>
ffffffffc0201d7c:	6394                	ld	a3,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0201d7e:	000aa797          	auipc	a5,0xaa
ffffffffc0201d82:	7ca78793          	addi	a5,a5,1994 # ffffffffc02ac548 <npage>
...
ffffffffc0201d9e:	81e68693          	addi	a3,a3,-2018 # ffffffffc02ac5b8 <pages>
...
ffffffffc0201dcc:	77078793          	addi	a5,a5,1904 # ffffffffc02ac538 <bigblocks>
...
ffffffffc0201dea:	7487b923          	sd	s0,1874(a5) # ffffffffc02ac538 <bigblocks>
...
ffffffffc0201dfc:	7487b023          	sd	s0,1856(a5) # ffffffffc02ac538 <bigblocks>
...
ffffffffc0201e68:	73c48493          	addi	s1,s1,1852 # ffffffffc02ac5a0 <pmm_manager>
        {
...
ffffffffc0201e72:	6eaa0a13          	addi	s4,s4,1770 # ffffffffc02ac558 <swap_init_ok>
...
ffffffffc0201e7e:	81ea8a93          	addi	s5,s5,-2018 # ffffffffc02ac698 <check_mm_struct>
...
ffffffffc0201ee6:	6be78793          	addi	a5,a5,1726 # ffffffffc02ac5a0 <pmm_manager>
...
ffffffffc0201f06:	69e78793          	addi	a5,a5,1694 # ffffffffc02ac5a0 <pmm_manager>
...
ffffffffc0201f2c:	67878793          	addi	a5,a5,1656 # ffffffffc02ac5a0 <pmm_manager>
...
ffffffffc0201f46:	65e78793          	addi	a5,a5,1630 # ffffffffc02ac5a0 <pmm_manager>
...
ffffffffc0201f8c:	5c098993          	addi	s3,s3,1472 # ffffffffc02ac548 <npage>
    if (!(*pdep1 & PTE_V)) {
...
ffffffffc0201fa6:	616b0b13          	addi	s6,s6,1558 # ffffffffc02ac5b8 <pages>
...
ffffffffc0201fb4:	59898993          	addi	s3,s3,1432 # ffffffffc02ac548 <npage>
    return page - pages + nbase;
...
ffffffffc0201fda:	5d278793          	addi	a5,a5,1490 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc0201fe6:	628040ef          	jal	ra,ffffffffc020660e <memset>
    return page - pages + nbase;
...
ffffffffc0202014:	598a8a93          	addi	s5,s5,1432 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc0202046:	576b0b13          	addi	s6,s6,1398 # ffffffffc02ac5b8 <pages>
...
ffffffffc0202078:	596040ef          	jal	ra,ffffffffc020660e <memset>
    return page - pages + nbase;
...
ffffffffc020215c:	3f070713          	addi	a4,a4,1008 # ffffffffc02ac548 <npage>
...
ffffffffc020216e:	44e70713          	addi	a4,a4,1102 # ffffffffc02ac5b8 <pages>
...
ffffffffc02021d6:	376c8c93          	addi	s9,s9,886 # ffffffffc02ac548 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02021da:	000aac17          	auipc	s8,0xaa
ffffffffc02021de:	3dec0c13          	addi	s8,s8,990 # ffffffffc02ac5b8 <pages>
...
ffffffffc0202322:	22ad0d13          	addi	s10,s10,554 # ffffffffc02ac548 <npage>
    return KADDR(page2pa(page));
ffffffffc0202326:	00cddd93          	srli	s11,s11,0xc
ffffffffc020232a:	000aa717          	auipc	a4,0xaa
ffffffffc020232e:	27e70713          	addi	a4,a4,638 # ffffffffc02ac5a8 <va_pa_offset>
    return &pages[PPN(pa) - nbase];
ffffffffc0202332:	000aae97          	auipc	t4,0xaa
ffffffffc0202336:	286e8e93          	addi	t4,t4,646 # ffffffffc02ac5b8 <pages>
        if (pde1&PTE_V){
...
ffffffffc0202418:	1a4e8e93          	addi	t4,t4,420 # ffffffffc02ac5b8 <pages>
...
ffffffffc020242e:	17e70713          	addi	a4,a4,382 # ffffffffc02ac5a8 <va_pa_offset>
            } while (d0start != 0 && d0start < d1start+PDSIZE && d0start < end);
...
ffffffffc0202458:	15470713          	addi	a4,a4,340 # ffffffffc02ac5a8 <va_pa_offset>
ffffffffc020245c:	c0000337          	lui	t1,0xc0000
ffffffffc0202460:	6e02                	ld	t3,0(sp)
ffffffffc0202462:	000aae97          	auipc	t4,0xaa
ffffffffc0202466:	156e8e93          	addi	t4,t4,342 # ffffffffc02ac5b8 <pages>
    } while (d1start != 0 && d1start < end);
...
ffffffffc020252c:	02070713          	addi	a4,a4,32 # ffffffffc02ac548 <npage>
...
ffffffffc020253e:	07e70713          	addi	a4,a4,126 # ffffffffc02ac5b8 <pages>
...
ffffffffc02025aa:	01278793          	addi	a5,a5,18 # ffffffffc02ac5b8 <pages>
...
ffffffffc02025e0:	f6c70713          	addi	a4,a4,-148 # ffffffffc02ac548 <npage>
...
ffffffffc02025f2:	fcaa0a13          	addi	s4,s4,-54 # ffffffffc02ac5b8 <pages>
...
ffffffffc020264e:	f4f73b23          	sd	a5,-170(a4) # ffffffffc02ac5a0 <pmm_manager>
void pmm_init(void) {
...
ffffffffc0202668:	f3c40413          	addi	s0,s0,-196 # ffffffffc02ac5a0 <pmm_manager>
    cprintf("memory management: %s\n", pmm_manager->name);
...
ffffffffc0202676:	ed648493          	addi	s1,s1,-298 # ffffffffc02ac548 <npage>
ffffffffc020267a:	000aa917          	auipc	s2,0xaa
ffffffffc020267e:	f3e90913          	addi	s2,s2,-194 # ffffffffc02ac5b8 <pages>
...
ffffffffc0202696:	f0f73b23          	sd	a5,-234(a4) # ffffffffc02ac5a8 <va_pa_offset>
    cprintf("physcial memory map:\n");
...
ffffffffc02026c0:	ff378793          	addi	a5,a5,-13 # ffffffffc02ad6af <end+0xfff>
ffffffffc02026c4:	8ff9                	and	a5,a5,a4
    npage = maxpa / PGSIZE;
ffffffffc02026c6:	00088737          	lui	a4,0x88
ffffffffc02026ca:	000aa697          	auipc	a3,0xaa
ffffffffc02026ce:	e6e6bf23          	sd	a4,-386(a3) # ffffffffc02ac548 <npage>
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc02026d2:	000aa717          	auipc	a4,0xaa
ffffffffc02026d6:	eef73323          	sd	a5,-282(a4) # ffffffffc02ac5b8 <pages>
...
ffffffffc020271c:	e9098993          	addi	s3,s3,-368 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc020276a:	dda40413          	addi	s0,s0,-550 # ffffffffc02ac540 <boot_pgdir>
    pmm_manager->check();
...
ffffffffc020278a:	dad7bd23          	sd	a3,-582(a5) # ffffffffc02ac540 <boot_pgdir>
...
ffffffffc02027a0:	e0d7ba23          	sd	a3,-492(a5) # ffffffffc02ac5b0 <boot_cr3>
...
ffffffffc0202a80:	335030ef          	jal	ra,ffffffffc02065b4 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a84:	100b0593          	addi	a1,s6,256
ffffffffc0202a88:	10000513          	li	a0,256
ffffffffc0202a8c:	33b030ef          	jal	ra,ffffffffc02065c6 <strcmp>
...
ffffffffc0202ac0:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fd52a50>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202ac4:	2ad030ef          	jal	ra,ffffffffc0206570 <strlen>
...
ffffffffc0202ad0:	609c                	ld	a5,0(s1)
    return pa2page(PDE_ADDR(pde));
ffffffffc0202ad2:	000bb683          	ld	a3,0(s7) # fffffffffffff000 <end+0x3fd52950>
...
ffffffffc020310a:	442c0c13          	addi	s8,s8,1090 # ffffffffc02ac548 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc020310e:	000a9b97          	auipc	s7,0xa9
ffffffffc0203112:	4aab8b93          	addi	s7,s7,1194 # ffffffffc02ac5b8 <pages>
    return page - pages + nbase;
...
ffffffffc02031c2:	3ea70713          	addi	a4,a4,1002 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc02031de:	442030ef          	jal	ra,ffffffffc0206620 <memcpy>
...
ffffffffc0203326:	23678793          	addi	a5,a5,566 # ffffffffc02ac558 <swap_init_ok>
...
ffffffffc0203334:	36878793          	addi	a5,a5,872 # ffffffffc02ac698 <check_mm_struct>
...
ffffffffc02033b0:	29c78793          	addi	a5,a5,668 # ffffffffc02ac648 <max_swap_offset>
...
ffffffffc02033c8:	d1478793          	addi	a5,a5,-748 # ffffffffc02a10d8 <swap_manager_fifo>
     int r = sm->init();
ffffffffc02033cc:	6798                	ld	a4,8(a5)
     sm = &swap_manager_fifo;
ffffffffc02033ce:	000a9697          	auipc	a3,0xa9
ffffffffc02033d2:	18f6b123          	sd	a5,386(a3) # ffffffffc02ac550 <sm>
     int r = sm->init();
...
ffffffffc0203400:	15478793          	addi	a5,a5,340 # ffffffffc02ac550 <sm>
...
ffffffffc0203412:	17a40413          	addi	s0,s0,378 # ffffffffc02ac588 <free_area>
ffffffffc0203416:	638c                	ld	a1,0(a5)
          swap_init_ok = 1;
ffffffffc0203418:	4785                	li	a5,1
ffffffffc020341a:	000a9717          	auipc	a4,0xa9
ffffffffc020341e:	12f72f23          	sw	a5,318(a4) # ffffffffc02ac558 <swap_init_ok>
          cprintf("SWAP: manager = %s\n", sm->name);
...
ffffffffc020347e:	21e78793          	addi	a5,a5,542 # ffffffffc02ac698 <check_mm_struct>
...
ffffffffc020348c:	0b878793          	addi	a5,a5,184 # ffffffffc02ac540 <boot_pgdir>
ffffffffc0203490:	0007bb03          	ld	s6,0(a5)
     check_mm_struct = mm;
ffffffffc0203494:	000a9797          	auipc	a5,0xa9
ffffffffc0203498:	20a7b223          	sd	a0,516(a5) # ffffffffc02ac698 <check_mm_struct>
     assert(pgdir[0] == 0);
...
ffffffffc02034e6:	0de98993          	addi	s3,s3,222 # ffffffffc02ac5c0 <check_rp>
ffffffffc02034ea:	ca5fc0ef          	jal	ra,ffffffffc020018e <cprintf>
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc02034ee:	000a9a17          	auipc	s4,0xa9
ffffffffc02034f2:	0f2a0a13          	addi	s4,s4,242 # ffffffffc02ac5e0 <swap_in_seq_no>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
...
ffffffffc020351a:	0aac0c13          	addi	s8,s8,170 # ffffffffc02ac5c0 <check_rp>
     list_entry_t free_list_store = free_list;
...
ffffffffc020352c:	0687b423          	sd	s0,104(a5) # ffffffffc02ac590 <free_area+0x8>
ffffffffc0203530:	000a9797          	auipc	a5,0xa9
ffffffffc0203534:	0487bc23          	sd	s0,88(a5) # ffffffffc02ac588 <free_area>
     nr_free = 0;
ffffffffc0203538:	000a9797          	auipc	a5,0xa9
ffffffffc020353c:	0607a023          	sw	zero,96(a5) # ffffffffc02ac598 <free_area+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc020356c:	fe07aa23          	sw	zero,-12(a5) # ffffffffc02ac55c <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
ffffffffc0203570:	4629                	li	a2,10
     pgfault_num=0;
ffffffffc0203572:	000a9797          	auipc	a5,0xa9
ffffffffc0203576:	fea78793          	addi	a5,a5,-22 # ffffffffc02ac55c <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02035f6:	fee78793          	addi	a5,a5,-18 # ffffffffc02ac5e0 <swap_in_seq_no>
ffffffffc02035fa:	000a9717          	auipc	a4,0xa9
ffffffffc02035fe:	00e70713          	addi	a4,a4,14 # ffffffffc02ac608 <swap_out_seq_no>
ffffffffc0203602:	000a9617          	auipc	a2,0xa9
ffffffffc0203606:	00660613          	addi	a2,a2,6 # ffffffffc02ac608 <swap_out_seq_no>
...
ffffffffc020361c:	05068693          	addi	a3,a3,80 # ffffffffc02ac668 <check_ptep>
ffffffffc0203620:	000a9817          	auipc	a6,0xa9
ffffffffc0203624:	fa080813          	addi	a6,a6,-96 # ffffffffc02ac5c0 <check_rp>
ffffffffc0203628:	6d05                	lui	s10,0x1
    if (PPN(pa) >= npage) {
ffffffffc020362a:	000a9c97          	auipc	s9,0xa9
ffffffffc020362e:	f1ec8c93          	addi	s9,s9,-226 # ffffffffc02ac548 <npage>
    return &pages[PPN(pa) - nbase];
...
ffffffffc020363e:	f7ec0c13          	addi	s8,s8,-130 # ffffffffc02ac5b8 <pages>
...
ffffffffc02036aa:	eaa78793          	addi	a5,a5,-342 # ffffffffc02ac550 <sm>
...
ffffffffc02036be:	ecf72f23          	sw	a5,-290(a4) # ffffffffc02ac598 <free_area+0x10>
     free_list = free_list_store;
ffffffffc02036c2:	67e2                	ld	a5,24(sp)
ffffffffc02036c4:	000a9717          	auipc	a4,0xa9
ffffffffc02036c8:	ecf73223          	sd	a5,-316(a4) # ffffffffc02ac588 <free_area>
ffffffffc02036cc:	7782                	ld	a5,32(sp)
ffffffffc02036ce:	000a9717          	auipc	a4,0xa9
ffffffffc02036d2:	ecf73123          	sd	a5,-318(a4) # ffffffffc02ac590 <free_area+0x8>
...
ffffffffc02036f4:	e5078793          	addi	a5,a5,-432 # ffffffffc02ac540 <boot_pgdir>
ffffffffc02036f8:	639c                	ld	a5,0(a5)
     check_mm_struct = NULL;
ffffffffc02036fa:	000a9697          	auipc	a3,0xa9
ffffffffc02036fe:	f806bf23          	sd	zero,-98(a3) # ffffffffc02ac698 <check_mm_struct>
    if (PPN(pa) >= npage) {
...
ffffffffc020372e:	e7e78793          	addi	a5,a5,-386 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc0203b10:	a4478793          	addi	a5,a5,-1468 # ffffffffc02ac550 <sm>
...
ffffffffc0203b20:	a3478793          	addi	a5,a5,-1484 # ffffffffc02ac550 <sm>
...
ffffffffc0203b50:	a0498993          	addi	s3,s3,-1532 # ffffffffc02ac550 <sm>
...
ffffffffc0203cbe:	9ce78793          	addi	a5,a5,-1586 # ffffffffc02ac688 <pra_list_head>
 */
static int
...
ffffffffc0203d00:	86040413          	addi	s0,s0,-1952 # ffffffffc02ac55c <pgfault_num>
    cprintf("write Virt Page c in fifo_check_swap\n");
...
ffffffffc02040dc:	48078793          	addi	a5,a5,1152 # ffffffffc02ac558 <swap_init_ok>
...
ffffffffc0204616:	08a7b323          	sd	a0,134(a5) # ffffffffc02ac698 <check_mm_struct>
...
ffffffffc0204624:	f2078793          	addi	a5,a5,-224 # ffffffffc02ac540 <boot_pgdir>
...
ffffffffc02046a2:	eaaa8a93          	addi	s5,s5,-342 # ffffffffc02ac548 <npage>
...
ffffffffc02046d8:	ed478793          	addi	a5,a5,-300 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc02046fa:	ec240413          	addi	s0,s0,-318 # ffffffffc02ac5b8 <pages>
...
ffffffffc0204744:	f407bc23          	sd	zero,-168(a5) # ffffffffc02ac698 <check_mm_struct>
...
ffffffffc02049c2:	b9e78793          	addi	a5,a5,-1122 # ffffffffc02ac55c <pgfault_num>
ffffffffc02049c6:	439c                	lw	a5,0(a5)
ffffffffc02049c8:	2785                	addiw	a5,a5,1
ffffffffc02049ca:	000a8717          	auipc	a4,0xa8
ffffffffc02049ce:	b8f72923          	sw	a5,-1134(a4) # ffffffffc02ac55c <pgfault_num>
...
ffffffffc02049fa:	b6278793          	addi	a5,a5,-1182 # ffffffffc02ac558 <swap_init_ok>
...
ffffffffc0204b5e:	aea7b723          	sd	a0,-1298(a5) # ffffffffc02ac648 <max_swap_offset>
}
...
ffffffffc0204b8a:	ac270713          	addi	a4,a4,-1342 # ffffffffc02ac648 <max_swap_offset>
...
ffffffffc0204b98:	a2470713          	addi	a4,a4,-1500 # ffffffffc02ac5b8 <pages>
...
ffffffffc0204baa:	9a268693          	addi	a3,a3,-1630 # ffffffffc02ac548 <npage>
    return page - pages + nbase;
...
ffffffffc0204bce:	9de78793          	addi	a5,a5,-1570 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc0204c22:	a2a70713          	addi	a4,a4,-1494 # ffffffffc02ac648 <max_swap_offset>
...
ffffffffc0204c30:	98c70713          	addi	a4,a4,-1652 # ffffffffc02ac5b8 <pages>
...
ffffffffc0204c42:	90a68693          	addi	a3,a3,-1782 # ffffffffc02ac548 <npage>
    return page - pages + nbase;
...
ffffffffc0204c66:	94678793          	addi	a5,a5,-1722 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc0204cae:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204cb0:	734000ef          	jal	ra,ffffffffc02053e4 <do_exit>
...
ffffffffc0204cea:	125010ef          	jal	ra,ffffffffc020660e <memset>
        proc->tf = NULL;
        proc->cr3 = boot_cr3;
ffffffffc0204cee:	000a8797          	auipc	a5,0xa8
ffffffffc0204cf2:	8c278793          	addi	a5,a5,-1854 # ffffffffc02ac5b0 <boot_cr3>
...
ffffffffc0204d0a:	105010ef          	jal	ra,ffffffffc020660e <memset>
...
ffffffffc0204d2c:	83878793          	addi	a5,a5,-1992 # ffffffffc02ac560 <current>
...
ffffffffc0204d3c:	82878793          	addi	a5,a5,-2008 # ffffffffc02ac560 <current>
...
ffffffffc0204d7e:	7f2010ef          	jal	ra,ffffffffc0206570 <strlen>
...
ffffffffc0204daa:	35300593          	li	a1,851
...
ffffffffc0204dcc:	7e078793          	addi	a5,a5,2016 # ffffffffc02ac5a8 <va_pa_offset>
ffffffffc0204dd0:	6388                	ld	a0,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0204dd2:	000a7797          	auipc	a5,0xa7
ffffffffc0204dd6:	77678793          	addi	a5,a5,1910 # ffffffffc02ac548 <npage>
...
ffffffffc0204df2:	7ca70713          	addi	a4,a4,1994 # ffffffffc02ac5b8 <pages>
...
ffffffffc0204e4e:	76e78793          	addi	a5,a5,1902 # ffffffffc02ac5b8 <pages>
...
ffffffffc0204e66:	6e670713          	addi	a4,a4,1766 # ffffffffc02ac548 <npage>
    return page - pages + nbase;
...
ffffffffc0204e80:	72c78793          	addi	a5,a5,1836 # ffffffffc02ac5a8 <va_pa_offset>
ffffffffc0204e84:	6380                	ld	s0,0(a5)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0204e86:	000a7797          	auipc	a5,0xa7
ffffffffc0204e8a:	6ba78793          	addi	a5,a5,1722 # ffffffffc02ac540 <boot_pgdir>
...
ffffffffc0204e96:	78a010ef          	jal	ra,ffffffffc0206620 <memcpy>
    return 0;
...
ffffffffc0204ed6:	ec06                	sd	ra,24(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204ed8:	736010ef          	jal	ra,ffffffffc020660e <memset>
...
ffffffffc0204ee8:	6105                	addi	sp,sp,32
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204eea:	7360106f          	j	ffffffffc0206620 <memcpy>
...
ffffffffc0204ef4:	67078793          	addi	a5,a5,1648 # ffffffffc02ac560 <current>
proc_run(struct proc_struct *proc) {
...
ffffffffc0204f18:	64873623          	sd	s0,1612(a4) # ffffffffc02ac560 <current>
...
ffffffffc0204f30:	7d5000ef          	jal	ra,ffffffffc0205f04 <switch_to>
    if (flag) {
...
ffffffffc0204f74:	e406                	sd	ra,8(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204f76:	1ea010ef          	jal	ra,ffffffffc0206160 <hash32>
ffffffffc0204f7a:	02051693          	slli	a3,a0,0x20
ffffffffc0204f7e:	82f1                	srli	a3,a3,0x1c
ffffffffc0204f80:	000a3517          	auipc	a0,0xa3
ffffffffc0204f84:	5a850513          	addi	a0,a0,1448 # ffffffffc02a8528 <hash_list>
...
ffffffffc0204fbe:	5bea0a13          	addi	s4,s4,1470 # ffffffffc02ac578 <nr_process>
...
ffffffffc0204fe0:	30f75b63          	ble	a5,a4,ffffffffc02052f6 <do_fork+0x340>
...
ffffffffc0204ff0:	2e050563          	beqz	a0,ffffffffc02052da <do_fork+0x324>
    proc->parent = current;
ffffffffc0204ff4:	000a7c17          	auipc	s8,0xa7
ffffffffc0204ff8:	56cc0c13          	addi	s8,s8,1388 # ffffffffc02ac560 <current>
...
ffffffffc0205004:	f11c                	sd	a5,32(a0)
    assert(current->wait_state == 0); //确保进程在等待
ffffffffc0205006:	30071663          	bnez	a4,ffffffffc0205312 <do_fork+0x35c>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020500a:	4509                	li	a0,2
ffffffffc020500c:	e47fc0ef          	jal	ra,ffffffffc0201e52 <alloc_pages>
    if (page != NULL) {
ffffffffc0205010:	2c050263          	beqz	a0,ffffffffc02052d4 <do_fork+0x31e>
    return page - pages + nbase;
ffffffffc0205014:	000a7a97          	auipc	s5,0xa7
ffffffffc0205018:	5a4a8a93          	addi	s5,s5,1444 # ffffffffc02ac5b8 <pages>
...
ffffffffc0205034:	518b8b93          	addi	s7,s7,1304 # ffffffffc02ac548 <npage>
    return page - pages + nbase;
...
ffffffffc0205046:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205048:	2ae7f963          	bleu	a4,a5,ffffffffc02052fa <do_fork+0x344>
ffffffffc020504c:	000a7c97          	auipc	s9,0xa7
ffffffffc0205050:	55cc8c93          	addi	s9,s9,1372 # ffffffffc02ac5a8 <va_pa_offset>
...
ffffffffc020506c:	1e098263          	beqz	s3,ffffffffc0205250 <do_fork+0x29a>
}
...
ffffffffc0205082:	03843423          	sd	s8,40(s0)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0205086:	2ad7e663          	bltu	a5,a3,ffffffffc0205332 <do_fork+0x37c>
...
ffffffffc02050c4:	12090f63          	beqz	s2,ffffffffc0205202 <do_fork+0x24c>
...
ffffffffc02050dc:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02050de:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02050e0:	14079063          	bnez	a5,ffffffffc0205220 <do_fork+0x26a>
    if (++ last_pid >= MAX_PID) {
ffffffffc02050e4:	0009c797          	auipc	a5,0x9c
ffffffffc02050e8:	03c78793          	addi	a5,a5,60 # ffffffffc02a1120 <last_pid.1691>
...
ffffffffc02050f8:	02a6a623          	sw	a0,44(a3) # ffffffffc02a1120 <last_pid.1691>
ffffffffc02050fc:	14e55363          	ble	a4,a0,ffffffffc0205242 <do_fork+0x28c>
    if (last_pid >= next_safe) {
ffffffffc0205100:	0009c797          	auipc	a5,0x9c
ffffffffc0205104:	02478793          	addi	a5,a5,36 # ffffffffc02a1124 <next_safe.1690>
ffffffffc0205108:	439c                	lw	a5,0(a5)
ffffffffc020510a:	000a7617          	auipc	a2,0xa7
ffffffffc020510e:	59660613          	addi	a2,a2,1430 # ffffffffc02ac6a0 <proc_list>
ffffffffc0205112:	06f54163          	blt	a0,a5,ffffffffc0205174 <do_fork+0x1be>
        next_safe = MAX_PID;
ffffffffc0205116:	6789                	lui	a5,0x2
ffffffffc0205118:	0009c717          	auipc	a4,0x9c
ffffffffc020511c:	00f72623          	sw	a5,12(a4) # ffffffffc02a1124 <next_safe.1690>
ffffffffc0205120:	4801                	li	a6,0
ffffffffc0205122:	87aa                	mv	a5,a0
ffffffffc0205124:	000a7617          	auipc	a2,0xa7
ffffffffc0205128:	57c60613          	addi	a2,a2,1404 # ffffffffc02ac6a0 <proc_list>
    repeat:
ffffffffc020512c:	6309                	lui	t1,0x2
ffffffffc020512e:	88c2                	mv	a7,a6
ffffffffc0205130:	6589                	lui	a1,0x2
        le = list;
ffffffffc0205132:	000a7697          	auipc	a3,0xa7
ffffffffc0205136:	56e68693          	addi	a3,a3,1390 # ffffffffc02ac6a0 <proc_list>
ffffffffc020513a:	6694                	ld	a3,8(a3)
        while ((le = list_next(le)) != list) {
ffffffffc020513c:	00c68f63          	beq	a3,a2,ffffffffc020515a <do_fork+0x1a4>
            if (proc->pid == last_pid) {
ffffffffc0205140:	f3c6a703          	lw	a4,-196(a3)
ffffffffc0205144:	0ae78a63          	beq	a5,a4,ffffffffc02051f8 <do_fork+0x242>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0205148:	fee7d9e3          	ble	a4,a5,ffffffffc020513a <do_fork+0x184>
ffffffffc020514c:	feb757e3          	ble	a1,a4,ffffffffc020513a <do_fork+0x184>
ffffffffc0205150:	6694                	ld	a3,8(a3)
ffffffffc0205152:	85ba                	mv	a1,a4
ffffffffc0205154:	4885                	li	a7,1
        while ((le = list_next(le)) != list) {
ffffffffc0205156:	fec695e3          	bne	a3,a2,ffffffffc0205140 <do_fork+0x18a>
ffffffffc020515a:	00080763          	beqz	a6,ffffffffc0205168 <do_fork+0x1b2>
ffffffffc020515e:	0009c717          	auipc	a4,0x9c
ffffffffc0205162:	fcf72123          	sw	a5,-62(a4) # ffffffffc02a1120 <last_pid.1691>
ffffffffc0205166:	853e                	mv	a0,a5
ffffffffc0205168:	00088663          	beqz	a7,ffffffffc0205174 <do_fork+0x1be>
ffffffffc020516c:	0009c797          	auipc	a5,0x9c
ffffffffc0205170:	fab7ac23          	sw	a1,-72(a5) # ffffffffc02a1124 <next_safe.1690>
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205174:	7018                	ld	a4,32(s0)
    __list_add(elm, listelm, listelm->next);
ffffffffc0205176:	6614                	ld	a3,8(a2)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0205178:	0c840593          	addi	a1,s0,200
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc020517c:	7b7c                	ld	a5,240(a4)
        proc->pid = get_pid();
ffffffffc020517e:	c048                	sw	a0,4(s0)
    prev->next = next->prev = elm;
ffffffffc0205180:	e28c                	sd	a1,0(a3)
ffffffffc0205182:	000a7817          	auipc	a6,0xa7
ffffffffc0205186:	52b83323          	sd	a1,1318(a6) # ffffffffc02ac6a8 <proc_list+0x8>
    elm->next = next;
ffffffffc020518a:	e874                	sd	a3,208(s0)
    elm->prev = prev;
ffffffffc020518c:	e470                	sd	a2,200(s0)
    proc->yptr = NULL;
ffffffffc020518e:	0e043c23          	sd	zero,248(s0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205192:	10f43023          	sd	a5,256(s0)
ffffffffc0205196:	c391                	beqz	a5,ffffffffc020519a <do_fork+0x1e4>
        proc->optr->yptr = proc;
ffffffffc0205198:	ffe0                	sd	s0,248(a5)
    nr_process ++;
ffffffffc020519a:	000a2783          	lw	a5,0(s4)
    proc->parent->cptr = proc;
ffffffffc020519e:	fb60                	sd	s0,240(a4)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02051a0:	45a9                	li	a1,10
    nr_process ++;
ffffffffc02051a2:	2785                	addiw	a5,a5,1
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02051a4:	2501                	sext.w	a0,a0
    nr_process ++;
ffffffffc02051a6:	000a7717          	auipc	a4,0xa7
ffffffffc02051aa:	3cf72923          	sw	a5,978(a4) # ffffffffc02ac578 <nr_process>
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02051ae:	7b3000ef          	jal	ra,ffffffffc0206160 <hash32>
ffffffffc02051b2:	1502                	slli	a0,a0,0x20
ffffffffc02051b4:	000a3797          	auipc	a5,0xa3
ffffffffc02051b8:	37478793          	addi	a5,a5,884 # ffffffffc02a8528 <hash_list>
ffffffffc02051bc:	8171                	srli	a0,a0,0x1c
ffffffffc02051be:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02051c0:	651c                	ld	a5,8(a0)
ffffffffc02051c2:	0d840713          	addi	a4,s0,216
    prev->next = next->prev = elm;
ffffffffc02051c6:	e398                	sd	a4,0(a5)
ffffffffc02051c8:	e518                	sd	a4,8(a0)
    elm->next = next;
ffffffffc02051ca:	f07c                	sd	a5,224(s0)
    elm->prev = prev;
ffffffffc02051cc:	ec68                	sd	a0,216(s0)
    if (flag) {
ffffffffc02051ce:	10049863          	bnez	s1,ffffffffc02052de <do_fork+0x328>
    wakeup_proc(proc);
ffffffffc02051d2:	8522                	mv	a0,s0
ffffffffc02051d4:	59b000ef          	jal	ra,ffffffffc0205f6e <wakeup_proc>
    ret = proc->pid;
ffffffffc02051d8:	4048                	lw	a0,4(s0)
}
ffffffffc02051da:	70a6                	ld	ra,104(sp)
ffffffffc02051dc:	7406                	ld	s0,96(sp)
ffffffffc02051de:	64e6                	ld	s1,88(sp)
ffffffffc02051e0:	6946                	ld	s2,80(sp)
ffffffffc02051e2:	69a6                	ld	s3,72(sp)
ffffffffc02051e4:	6a06                	ld	s4,64(sp)
ffffffffc02051e6:	7ae2                	ld	s5,56(sp)
ffffffffc02051e8:	7b42                	ld	s6,48(sp)
ffffffffc02051ea:	7ba2                	ld	s7,40(sp)
ffffffffc02051ec:	7c02                	ld	s8,32(sp)
ffffffffc02051ee:	6ce2                	ld	s9,24(sp)
ffffffffc02051f0:	6d42                	ld	s10,16(sp)
ffffffffc02051f2:	6da2                	ld	s11,8(sp)
ffffffffc02051f4:	6165                	addi	sp,sp,112
ffffffffc02051f6:	8082                	ret
                if (++ last_pid >= next_safe) {
ffffffffc02051f8:	2785                	addiw	a5,a5,1
ffffffffc02051fa:	0eb7d563          	ble	a1,a5,ffffffffc02052e4 <do_fork+0x32e>
ffffffffc02051fe:	4805                	li	a6,1
ffffffffc0205200:	bf2d                	j	ffffffffc020513a <do_fork+0x184>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0205202:	8936                	mv	s2,a3
ffffffffc0205204:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0205208:	00000797          	auipc	a5,0x0
ffffffffc020520c:	b2078793          	addi	a5,a5,-1248 # ffffffffc0204d28 <forkret>
ffffffffc0205210:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0205212:	fc14                	sd	a3,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205214:	100027f3          	csrr	a5,sstatus
ffffffffc0205218:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020521a:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020521c:	ec0784e3          	beqz	a5,ffffffffc02050e4 <do_fork+0x12e>
        intr_disable();
ffffffffc0205220:	c3afb0ef          	jal	ra,ffffffffc020065a <intr_disable>
    if (++ last_pid >= MAX_PID) {
ffffffffc0205224:	0009c797          	auipc	a5,0x9c
ffffffffc0205228:	efc78793          	addi	a5,a5,-260 # ffffffffc02a1120 <last_pid.1691>
ffffffffc020522c:	439c                	lw	a5,0(a5)
ffffffffc020522e:	6709                	lui	a4,0x2
        return 1;
ffffffffc0205230:	4485                	li	s1,1
ffffffffc0205232:	0017851b          	addiw	a0,a5,1
ffffffffc0205236:	0009c697          	auipc	a3,0x9c
ffffffffc020523a:	eea6a523          	sw	a0,-278(a3) # ffffffffc02a1120 <last_pid.1691>
ffffffffc020523e:	ece541e3          	blt	a0,a4,ffffffffc0205100 <do_fork+0x14a>
        last_pid = 1;
ffffffffc0205242:	4785                	li	a5,1
ffffffffc0205244:	0009c717          	auipc	a4,0x9c
ffffffffc0205248:	ecf72e23          	sw	a5,-292(a4) # ffffffffc02a1120 <last_pid.1691>
ffffffffc020524c:	4505                	li	a0,1
ffffffffc020524e:	b5e1                	j	ffffffffc0205116 <do_fork+0x160>
    if ((mm = mm_create()) == NULL) {
ffffffffc0205250:	e77fe0ef          	jal	ra,ffffffffc02040c6 <mm_create>
ffffffffc0205254:	8d2a                	mv	s10,a0
ffffffffc0205256:	c539                	beqz	a0,ffffffffc02052a4 <do_fork+0x2ee>
    if (setup_pgdir(mm) != 0) {
ffffffffc0205258:	be1ff0ef          	jal	ra,ffffffffc0204e38 <setup_pgdir>
ffffffffc020525c:	e949                	bnez	a0,ffffffffc02052ee <do_fork+0x338>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc020525e:	038c0d93          	addi	s11,s8,56
...
ffffffffc0205264:	40fdb7af          	amoor.d	a5,a5,(s11)
ffffffffc0205268:	8b85                	andi	a5,a5,1
ffffffffc020526a:	4985                	li	s3,1
...
lock(lock_t *lock) {
    while (!try_lock(lock)) {
ffffffffc020526c:	c799                	beqz	a5,ffffffffc020527a <do_fork+0x2c4>
        schedule();
ffffffffc020526e:	57d000ef          	jal	ra,ffffffffc0205fea <schedule>
ffffffffc0205272:	413db7af          	amoor.d	a5,s3,(s11)
ffffffffc0205276:	8b85                	andi	a5,a5,1
    while (!try_lock(lock)) {
ffffffffc0205278:	fbfd                	bnez	a5,ffffffffc020526e <do_fork+0x2b8>
        ret = dup_mmap(mm, oldmm);
ffffffffc020527a:	85e2                	mv	a1,s8
ffffffffc020527c:	856a                	mv	a0,s10
ffffffffc020527e:	8d2ff0ef          	jal	ra,ffffffffc0204350 <dup_mmap>
...
ffffffffc0205282:	57f9                	li	a5,-2
ffffffffc0205284:	60fdb7af          	amoand.d	a5,a5,(s11)
...
ffffffffc020528a:	c3e9                	beqz	a5,ffffffffc020534c <do_fork+0x396>
    if (ret != 0) {
ffffffffc020528c:	8c6a                	mv	s8,s10
ffffffffc020528e:	de0501e3          	beqz	a0,ffffffffc0205070 <do_fork+0xba>
    exit_mmap(mm);
ffffffffc0205292:	856a                	mv	a0,s10
ffffffffc0205294:	958ff0ef          	jal	ra,ffffffffc02043ec <exit_mmap>
    put_pgdir(mm);
ffffffffc0205298:	856a                	mv	a0,s10
ffffffffc020529a:	b21ff0ef          	jal	ra,ffffffffc0204dba <put_pgdir>
    mm_destroy(mm);
ffffffffc020529e:	856a                	mv	a0,s10
ffffffffc02052a0:	fadfe0ef          	jal	ra,ffffffffc020424c <mm_destroy>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02052a4:	6814                	ld	a3,16(s0)
    return pa2page(PADDR(kva));
ffffffffc02052a6:	c02007b7          	lui	a5,0xc0200
ffffffffc02052aa:	0cf6e963          	bltu	a3,a5,ffffffffc020537c <do_fork+0x3c6>
ffffffffc02052ae:	000cb783          	ld	a5,0(s9)
    if (PPN(pa) >= npage) {
ffffffffc02052b2:	000bb703          	ld	a4,0(s7)
    return pa2page(PADDR(kva));
ffffffffc02052b6:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02052ba:	83b1                	srli	a5,a5,0xc
ffffffffc02052bc:	0ae7f463          	bleu	a4,a5,ffffffffc0205364 <do_fork+0x3ae>
    return &pages[PPN(pa) - nbase];
ffffffffc02052c0:	000b3703          	ld	a4,0(s6)
ffffffffc02052c4:	000ab503          	ld	a0,0(s5)
ffffffffc02052c8:	4589                	li	a1,2
ffffffffc02052ca:	8f99                	sub	a5,a5,a4
ffffffffc02052cc:	079a                	slli	a5,a5,0x6
...
ffffffffc02052d6:	a3dfc0ef          	jal	ra,ffffffffc0201d12 <kfree>
    ret = -E_NO_MEM;
ffffffffc02052da:	5571                	li	a0,-4
    return ret;
ffffffffc02052dc:	bdfd                	j	ffffffffc02051da <do_fork+0x224>
        intr_enable();
ffffffffc02052de:	b76fb0ef          	jal	ra,ffffffffc0200654 <intr_enable>
ffffffffc02052e2:	bdc5                	j	ffffffffc02051d2 <do_fork+0x21c>
                    if (last_pid >= MAX_PID) {
ffffffffc02052e4:	0067c363          	blt	a5,t1,ffffffffc02052ea <do_fork+0x334>
                        last_pid = 1;
ffffffffc02052e8:	4785                	li	a5,1
                    goto repeat;
ffffffffc02052ea:	4805                	li	a6,1
ffffffffc02052ec:	b589                	j	ffffffffc020512e <do_fork+0x178>
    mm_destroy(mm);
ffffffffc02052ee:	856a                	mv	a0,s10
ffffffffc02052f0:	f5dfe0ef          	jal	ra,ffffffffc020424c <mm_destroy>
ffffffffc02052f4:	bf45                	j	ffffffffc02052a4 <do_fork+0x2ee>
    int ret = -E_NO_FREE_PROC;
ffffffffc02052f6:	556d                	li	a0,-5
ffffffffc02052f8:	b5cd                	j	ffffffffc02051da <do_fork+0x224>
    return KADDR(page2pa(page));
ffffffffc02052fa:	00002617          	auipc	a2,0x2
ffffffffc02052fe:	0c660613          	addi	a2,a2,198 # ffffffffc02073c0 <default_pmm_manager+0x50>
ffffffffc0205302:	06900593          	li	a1,105
ffffffffc0205306:	00002517          	auipc	a0,0x2
ffffffffc020530a:	0e250513          	addi	a0,a0,226 # ffffffffc02073e8 <default_pmm_manager+0x78>
ffffffffc020530e:	976fb0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(current->wait_state == 0); //确保进程在等待
ffffffffc0205312:	00003697          	auipc	a3,0x3
ffffffffc0205316:	2c668693          	addi	a3,a3,710 # ffffffffc02085d8 <default_pmm_manager+0x1268>
ffffffffc020531a:	00002617          	auipc	a2,0x2
ffffffffc020531e:	90e60613          	addi	a2,a2,-1778 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc0205322:	1b400593          	li	a1,436
ffffffffc0205326:	00003517          	auipc	a0,0x3
ffffffffc020532a:	54250513          	addi	a0,a0,1346 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc020532e:	956fb0ef          	jal	ra,ffffffffc0200484 <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0205332:	86be                	mv	a3,a5
ffffffffc0205334:	00002617          	auipc	a2,0x2
ffffffffc0205338:	0c460613          	addi	a2,a2,196 # ffffffffc02073f8 <default_pmm_manager+0x88>
ffffffffc020533c:	16600593          	li	a1,358
ffffffffc0205340:	00003517          	auipc	a0,0x3
ffffffffc0205344:	52850513          	addi	a0,a0,1320 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205348:	93cfb0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("Unlock failed.\n");
ffffffffc020534c:	00003617          	auipc	a2,0x3
ffffffffc0205350:	2ac60613          	addi	a2,a2,684 # ffffffffc02085f8 <default_pmm_manager+0x1288>
ffffffffc0205354:	03100593          	li	a1,49
ffffffffc0205358:	00003517          	auipc	a0,0x3
ffffffffc020535c:	2b050513          	addi	a0,a0,688 # ffffffffc0208608 <default_pmm_manager+0x1298>
ffffffffc0205360:	924fb0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205364:	00002617          	auipc	a2,0x2
ffffffffc0205368:	0bc60613          	addi	a2,a2,188 # ffffffffc0207420 <default_pmm_manager+0xb0>
ffffffffc020536c:	06200593          	li	a1,98
ffffffffc0205370:	00002517          	auipc	a0,0x2
ffffffffc0205374:	07850513          	addi	a0,a0,120 # ffffffffc02073e8 <default_pmm_manager+0x78>
ffffffffc0205378:	90cfb0ef          	jal	ra,ffffffffc0200484 <__panic>
    return pa2page(PADDR(kva));
ffffffffc020537c:	00002617          	auipc	a2,0x2
ffffffffc0205380:	07c60613          	addi	a2,a2,124 # ffffffffc02073f8 <default_pmm_manager+0x88>
ffffffffc0205384:	06e00593          	li	a1,110
ffffffffc0205388:	00002517          	auipc	a0,0x2
ffffffffc020538c:	06050513          	addi	a0,a0,96 # ffffffffc02073e8 <default_pmm_manager+0x78>
ffffffffc0205390:	8f4fb0ef          	jal	ra,ffffffffc0200484 <__panic>

ffffffffc0205394 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0205394:	7129                	addi	sp,sp,-320
ffffffffc0205396:	fa22                	sd	s0,304(sp)
ffffffffc0205398:	f626                	sd	s1,296(sp)
ffffffffc020539a:	f24a                	sd	s2,288(sp)
ffffffffc020539c:	84ae                	mv	s1,a1
ffffffffc020539e:	892a                	mv	s2,a0
ffffffffc02053a0:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02053a2:	4581                	li	a1,0
ffffffffc02053a4:	12000613          	li	a2,288
ffffffffc02053a8:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02053aa:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02053ac:	262010ef          	jal	ra,ffffffffc020660e <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02053b0:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02053b2:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02053b4:	100027f3          	csrr	a5,sstatus
ffffffffc02053b8:	edd7f793          	andi	a5,a5,-291
ffffffffc02053bc:	1207e793          	ori	a5,a5,288
ffffffffc02053c0:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02053c2:	860a                	mv	a2,sp
ffffffffc02053c4:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02053c8:	00000797          	auipc	a5,0x0
ffffffffc02053cc:	8e478793          	addi	a5,a5,-1820 # ffffffffc0204cac <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02053d0:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02053d2:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02053d4:	be3ff0ef          	jal	ra,ffffffffc0204fb6 <do_fork>
}
ffffffffc02053d8:	70f2                	ld	ra,312(sp)
ffffffffc02053da:	7452                	ld	s0,304(sp)
ffffffffc02053dc:	74b2                	ld	s1,296(sp)
ffffffffc02053de:	7912                	ld	s2,288(sp)
ffffffffc02053e0:	6131                	addi	sp,sp,320
ffffffffc02053e2:	8082                	ret

ffffffffc02053e4 <do_exit>:
do_exit(int error_code) {
ffffffffc02053e4:	7179                	addi	sp,sp,-48
ffffffffc02053e6:	e84a                	sd	s2,16(sp)
    if (current == idleproc) {
ffffffffc02053e8:	000a7717          	auipc	a4,0xa7
ffffffffc02053ec:	18070713          	addi	a4,a4,384 # ffffffffc02ac568 <idleproc>
ffffffffc02053f0:	000a7917          	auipc	s2,0xa7
ffffffffc02053f4:	17090913          	addi	s2,s2,368 # ffffffffc02ac560 <current>
ffffffffc02053f8:	00093783          	ld	a5,0(s2)
ffffffffc02053fc:	6318                	ld	a4,0(a4)
do_exit(int error_code) {
ffffffffc02053fe:	f406                	sd	ra,40(sp)
ffffffffc0205400:	f022                	sd	s0,32(sp)
ffffffffc0205402:	ec26                	sd	s1,24(sp)
ffffffffc0205404:	e44e                	sd	s3,8(sp)
ffffffffc0205406:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc0205408:	0ce78c63          	beq	a5,a4,ffffffffc02054e0 <do_exit+0xfc>
    if (current == initproc) {
ffffffffc020540c:	000a7417          	auipc	s0,0xa7
ffffffffc0205410:	16440413          	addi	s0,s0,356 # ffffffffc02ac570 <initproc>
ffffffffc0205414:	6018                	ld	a4,0(s0)
ffffffffc0205416:	0ee78b63          	beq	a5,a4,ffffffffc020550c <do_exit+0x128>
    struct mm_struct *mm = current->mm;
ffffffffc020541a:	7784                	ld	s1,40(a5)
ffffffffc020541c:	89aa                	mv	s3,a0
    if (mm != NULL) {
ffffffffc020541e:	c48d                	beqz	s1,ffffffffc0205448 <do_exit+0x64>
        lcr3(boot_cr3);
ffffffffc0205420:	000a7797          	auipc	a5,0xa7
ffffffffc0205424:	19078793          	addi	a5,a5,400 # ffffffffc02ac5b0 <boot_cr3>
ffffffffc0205428:	639c                	ld	a5,0(a5)
ffffffffc020542a:	577d                	li	a4,-1
ffffffffc020542c:	177e                	slli	a4,a4,0x3f
ffffffffc020542e:	83b1                	srli	a5,a5,0xc
ffffffffc0205430:	8fd9                	or	a5,a5,a4
ffffffffc0205432:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc0205436:	589c                	lw	a5,48(s1)
ffffffffc0205438:	fff7871b          	addiw	a4,a5,-1
ffffffffc020543c:	d898                	sw	a4,48(s1)
        if (mm_count_dec(mm) == 0) {
ffffffffc020543e:	cf4d                	beqz	a4,ffffffffc02054f8 <do_exit+0x114>
        current->mm = NULL;
ffffffffc0205440:	00093783          	ld	a5,0(s2)
ffffffffc0205444:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc0205448:	00093783          	ld	a5,0(s2)
ffffffffc020544c:	470d                	li	a4,3
ffffffffc020544e:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc0205450:	0f37a423          	sw	s3,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205454:	100027f3          	csrr	a5,sstatus
ffffffffc0205458:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020545a:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020545c:	e7e1                	bnez	a5,ffffffffc0205524 <do_exit+0x140>
        proc = current->parent;
...
ffffffffc020546e:	0af70f63          	beq	a4,a5,ffffffffc020552c <do_exit+0x148>
ffffffffc0205472:	00093683          	ld	a3,0(s2)
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205476:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020547a:	448d                	li	s1,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020547c:	0985                	addi	s3,s3,1
        while (current->cptr != NULL) {
ffffffffc020547e:	7afc                	ld	a5,240(a3)
ffffffffc0205480:	cb95                	beqz	a5,ffffffffc02054b4 <do_exit+0xd0>
            current->cptr = proc->optr;
ffffffffc0205482:	1007b703          	ld	a4,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff5670>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205486:	6008                	ld	a0,0(s0)
            current->cptr = proc->optr;
ffffffffc0205488:	faf8                	sd	a4,240(a3)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020548a:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc020548c:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205490:	10e7b023          	sd	a4,256(a5)
ffffffffc0205494:	c311                	beqz	a4,ffffffffc0205498 <do_exit+0xb4>
                initproc->cptr->yptr = proc;
ffffffffc0205496:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205498:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc020549a:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc020549c:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020549e:	fe9710e3          	bne	a4,s1,ffffffffc020547e <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc02054a2:	0ec52783          	lw	a5,236(a0)
ffffffffc02054a6:	fd379ce3          	bne	a5,s3,ffffffffc020547e <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc02054aa:	2c5000ef          	jal	ra,ffffffffc0205f6e <wakeup_proc>
ffffffffc02054ae:	00093683          	ld	a3,0(s2)
ffffffffc02054b2:	b7f1                	j	ffffffffc020547e <do_exit+0x9a>
    if (flag) {
ffffffffc02054b4:	020a1363          	bnez	s4,ffffffffc02054da <do_exit+0xf6>
    schedule();
ffffffffc02054b8:	333000ef          	jal	ra,ffffffffc0205fea <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc02054bc:	00093783          	ld	a5,0(s2)
ffffffffc02054c0:	00003617          	auipc	a2,0x3
ffffffffc02054c4:	0f860613          	addi	a2,a2,248 # ffffffffc02085b8 <default_pmm_manager+0x1248>
ffffffffc02054c8:	20700593          	li	a1,519
ffffffffc02054cc:	43d4                	lw	a3,4(a5)
ffffffffc02054ce:	00003517          	auipc	a0,0x3
ffffffffc02054d2:	39a50513          	addi	a0,a0,922 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc02054d6:	faffa0ef          	jal	ra,ffffffffc0200484 <__panic>
        intr_enable();
ffffffffc02054da:	97afb0ef          	jal	ra,ffffffffc0200654 <intr_enable>
ffffffffc02054de:	bfe9                	j	ffffffffc02054b8 <do_exit+0xd4>
        panic("idleproc exit.\n");
ffffffffc02054e0:	00003617          	auipc	a2,0x3
ffffffffc02054e4:	0b860613          	addi	a2,a2,184 # ffffffffc0208598 <default_pmm_manager+0x1228>
ffffffffc02054e8:	1db00593          	li	a1,475
ffffffffc02054ec:	00003517          	auipc	a0,0x3
ffffffffc02054f0:	37c50513          	addi	a0,a0,892 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc02054f4:	f91fa0ef          	jal	ra,ffffffffc0200484 <__panic>
            exit_mmap(mm);
ffffffffc02054f8:	8526                	mv	a0,s1
ffffffffc02054fa:	ef3fe0ef          	jal	ra,ffffffffc02043ec <exit_mmap>
            put_pgdir(mm);
ffffffffc02054fe:	8526                	mv	a0,s1
ffffffffc0205500:	8bbff0ef          	jal	ra,ffffffffc0204dba <put_pgdir>
            mm_destroy(mm);
ffffffffc0205504:	8526                	mv	a0,s1
ffffffffc0205506:	d47fe0ef          	jal	ra,ffffffffc020424c <mm_destroy>
ffffffffc020550a:	bf1d                	j	ffffffffc0205440 <do_exit+0x5c>
        panic("initproc exit.\n");
ffffffffc020550c:	00003617          	auipc	a2,0x3
ffffffffc0205510:	09c60613          	addi	a2,a2,156 # ffffffffc02085a8 <default_pmm_manager+0x1238>
ffffffffc0205514:	1de00593          	li	a1,478
ffffffffc0205518:	00003517          	auipc	a0,0x3
ffffffffc020551c:	35050513          	addi	a0,a0,848 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205520:	f65fa0ef          	jal	ra,ffffffffc0200484 <__panic>
        intr_disable();
ffffffffc0205524:	936fb0ef          	jal	ra,ffffffffc020065a <intr_disable>
        return 1;
ffffffffc0205528:	4a05                	li	s4,1
ffffffffc020552a:	bf15                	j	ffffffffc020545e <do_exit+0x7a>
            wakeup_proc(proc);
ffffffffc020552c:	243000ef          	jal	ra,ffffffffc0205f6e <wakeup_proc>
ffffffffc0205530:	b789                	j	ffffffffc0205472 <do_exit+0x8e>

ffffffffc0205532 <do_wait.part.1>:
do_wait(int pid, int *code_store) {
ffffffffc0205532:	7139                	addi	sp,sp,-64
ffffffffc0205534:	e852                	sd	s4,16(sp)
        current->wait_state = WT_CHILD;
ffffffffc0205536:	80000a37          	lui	s4,0x80000
do_wait(int pid, int *code_store) {
ffffffffc020553a:	f426                	sd	s1,40(sp)
ffffffffc020553c:	f04a                	sd	s2,32(sp)
ffffffffc020553e:	ec4e                	sd	s3,24(sp)
ffffffffc0205540:	e456                	sd	s5,8(sp)
ffffffffc0205542:	e05a                	sd	s6,0(sp)
ffffffffc0205544:	fc06                	sd	ra,56(sp)
ffffffffc0205546:	f822                	sd	s0,48(sp)
ffffffffc0205548:	89aa                	mv	s3,a0
ffffffffc020554a:	8b2e                	mv	s6,a1
        proc = current->cptr;
ffffffffc020554c:	000a7917          	auipc	s2,0xa7
ffffffffc0205550:	01490913          	addi	s2,s2,20 # ffffffffc02ac560 <current>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205554:	448d                	li	s1,3
        current->state = PROC_SLEEPING;
ffffffffc0205556:	4a85                	li	s5,1
        current->wait_state = WT_CHILD;
ffffffffc0205558:	2a05                	addiw	s4,s4,1
    if (pid != 0) {
ffffffffc020555a:	02098f63          	beqz	s3,ffffffffc0205598 <do_wait.part.1+0x66>
        proc = find_proc(pid);
ffffffffc020555e:	854e                	mv	a0,s3
ffffffffc0205560:	9fbff0ef          	jal	ra,ffffffffc0204f5a <find_proc>
ffffffffc0205564:	842a                	mv	s0,a0
        if (proc != NULL && proc->parent == current) {
ffffffffc0205566:	12050063          	beqz	a0,ffffffffc0205686 <do_wait.part.1+0x154>
ffffffffc020556a:	00093703          	ld	a4,0(s2)
ffffffffc020556e:	711c                	ld	a5,32(a0)
ffffffffc0205570:	10e79b63          	bne	a5,a4,ffffffffc0205686 <do_wait.part.1+0x154>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205574:	411c                	lw	a5,0(a0)
ffffffffc0205576:	02978c63          	beq	a5,s1,ffffffffc02055ae <do_wait.part.1+0x7c>
        current->state = PROC_SLEEPING;
ffffffffc020557a:	01572023          	sw	s5,0(a4)
        current->wait_state = WT_CHILD;
ffffffffc020557e:	0f472623          	sw	s4,236(a4)
        schedule();
ffffffffc0205582:	269000ef          	jal	ra,ffffffffc0205fea <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc0205586:	00093783          	ld	a5,0(s2)
ffffffffc020558a:	0b07a783          	lw	a5,176(a5)
ffffffffc020558e:	8b85                	andi	a5,a5,1
ffffffffc0205590:	d7e9                	beqz	a5,ffffffffc020555a <do_wait.part.1+0x28>
            do_exit(-E_KILLED);
ffffffffc0205592:	555d                	li	a0,-9
ffffffffc0205594:	e51ff0ef          	jal	ra,ffffffffc02053e4 <do_exit>
        proc = current->cptr;
ffffffffc0205598:	00093703          	ld	a4,0(s2)
ffffffffc020559c:	7b60                	ld	s0,240(a4)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc020559e:	e409                	bnez	s0,ffffffffc02055a8 <do_wait.part.1+0x76>
ffffffffc02055a0:	a0dd                	j	ffffffffc0205686 <do_wait.part.1+0x154>
ffffffffc02055a2:	10043403          	ld	s0,256(s0)
ffffffffc02055a6:	d871                	beqz	s0,ffffffffc020557a <do_wait.part.1+0x48>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02055a8:	401c                	lw	a5,0(s0)
ffffffffc02055aa:	fe979ce3          	bne	a5,s1,ffffffffc02055a2 <do_wait.part.1+0x70>
    if (proc == idleproc || proc == initproc) {
ffffffffc02055ae:	000a7797          	auipc	a5,0xa7
ffffffffc02055b2:	fba78793          	addi	a5,a5,-70 # ffffffffc02ac568 <idleproc>
ffffffffc02055b6:	639c                	ld	a5,0(a5)
ffffffffc02055b8:	0c878d63          	beq	a5,s0,ffffffffc0205692 <do_wait.part.1+0x160>
ffffffffc02055bc:	000a7797          	auipc	a5,0xa7
ffffffffc02055c0:	fb478793          	addi	a5,a5,-76 # ffffffffc02ac570 <initproc>
ffffffffc02055c4:	639c                	ld	a5,0(a5)
ffffffffc02055c6:	0cf40663          	beq	s0,a5,ffffffffc0205692 <do_wait.part.1+0x160>
    if (code_store != NULL) {
ffffffffc02055ca:	000b0663          	beqz	s6,ffffffffc02055d6 <do_wait.part.1+0xa4>
        *code_store = proc->exit_code;
ffffffffc02055ce:	0e842783          	lw	a5,232(s0)
ffffffffc02055d2:	00fb2023          	sw	a5,0(s6)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc02055dc:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02055de:	e7d5                	bnez	a5,ffffffffc020568a <do_wait.part.1+0x158>
    __list_del(listelm->prev, listelm->next);
ffffffffc02055e0:	6c70                	ld	a2,216(s0)
ffffffffc02055e2:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL) {
ffffffffc02055e4:	10043703          	ld	a4,256(s0)
ffffffffc02055e8:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc02055ea:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc02055ec:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc02055ee:	6470                	ld	a2,200(s0)
ffffffffc02055f0:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc02055f2:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc02055f4:	e290                	sd	a2,0(a3)
ffffffffc02055f6:	c319                	beqz	a4,ffffffffc02055fc <do_wait.part.1+0xca>
        proc->optr->yptr = proc->yptr;
ffffffffc02055f8:	ff7c                	sd	a5,248(a4)
ffffffffc02055fa:	7c7c                	ld	a5,248(s0)
    if (proc->yptr != NULL) {
ffffffffc02055fc:	c3d1                	beqz	a5,ffffffffc0205680 <do_wait.part.1+0x14e>
        proc->yptr->optr = proc->optr;
ffffffffc02055fe:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc0205602:	000a7797          	auipc	a5,0xa7
ffffffffc0205606:	f7678793          	addi	a5,a5,-138 # ffffffffc02ac578 <nr_process>
ffffffffc020560a:	439c                	lw	a5,0(a5)
ffffffffc020560c:	37fd                	addiw	a5,a5,-1
ffffffffc020560e:	000a7717          	auipc	a4,0xa7
ffffffffc0205612:	f6f72523          	sw	a5,-150(a4) # ffffffffc02ac578 <nr_process>
    if (flag) {
ffffffffc0205616:	e1b5                	bnez	a1,ffffffffc020567a <do_wait.part.1+0x148>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0205618:	6814                	ld	a3,16(s0)
ffffffffc020561a:	c02007b7          	lui	a5,0xc0200
ffffffffc020561e:	0af6e263          	bltu	a3,a5,ffffffffc02056c2 <do_wait.part.1+0x190>
ffffffffc0205622:	000a7797          	auipc	a5,0xa7
ffffffffc0205626:	f8678793          	addi	a5,a5,-122 # ffffffffc02ac5a8 <va_pa_offset>
ffffffffc020562a:	6398                	ld	a4,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc020562c:	000a7797          	auipc	a5,0xa7
ffffffffc0205630:	f1c78793          	addi	a5,a5,-228 # ffffffffc02ac548 <npage>
ffffffffc0205634:	639c                	ld	a5,0(a5)
    return pa2page(PADDR(kva));
ffffffffc0205636:	8e99                	sub	a3,a3,a4
    if (PPN(pa) >= npage) {
ffffffffc0205638:	82b1                	srli	a3,a3,0xc
ffffffffc020563a:	06f6f863          	bleu	a5,a3,ffffffffc02056aa <do_wait.part.1+0x178>
    return &pages[PPN(pa) - nbase];
ffffffffc020563e:	00003797          	auipc	a5,0x3
ffffffffc0205642:	6f278793          	addi	a5,a5,1778 # ffffffffc0208d30 <nbase>
ffffffffc0205646:	639c                	ld	a5,0(a5)
ffffffffc0205648:	000a7717          	auipc	a4,0xa7
ffffffffc020564c:	f7070713          	addi	a4,a4,-144 # ffffffffc02ac5b8 <pages>
ffffffffc0205650:	6308                	ld	a0,0(a4)
ffffffffc0205652:	8e9d                	sub	a3,a3,a5
ffffffffc0205654:	069a                	slli	a3,a3,0x6
ffffffffc0205656:	9536                	add	a0,a0,a3
ffffffffc0205658:	4589                	li	a1,2
ffffffffc020565a:	881fc0ef          	jal	ra,ffffffffc0201eda <free_pages>
    kfree(proc);
ffffffffc020565e:	8522                	mv	a0,s0
ffffffffc0205660:	eb2fc0ef          	jal	ra,ffffffffc0201d12 <kfree>
    return 0;
ffffffffc0205664:	4501                	li	a0,0
}
ffffffffc0205666:	70e2                	ld	ra,56(sp)
ffffffffc0205668:	7442                	ld	s0,48(sp)
ffffffffc020566a:	74a2                	ld	s1,40(sp)
ffffffffc020566c:	7902                	ld	s2,32(sp)
ffffffffc020566e:	69e2                	ld	s3,24(sp)
ffffffffc0205670:	6a42                	ld	s4,16(sp)
ffffffffc0205672:	6aa2                	ld	s5,8(sp)
ffffffffc0205674:	6b02                	ld	s6,0(sp)
ffffffffc0205676:	6121                	addi	sp,sp,64
ffffffffc0205678:	8082                	ret
        intr_enable();
ffffffffc020567a:	fdbfa0ef          	jal	ra,ffffffffc0200654 <intr_enable>
ffffffffc020567e:	bf69                	j	ffffffffc0205618 <do_wait.part.1+0xe6>
       proc->parent->cptr = proc->optr;
ffffffffc0205680:	701c                	ld	a5,32(s0)
ffffffffc0205682:	fbf8                	sd	a4,240(a5)
ffffffffc0205684:	bfbd                	j	ffffffffc0205602 <do_wait.part.1+0xd0>
    return -E_BAD_PROC;
ffffffffc0205686:	5579                	li	a0,-2
ffffffffc0205688:	bff9                	j	ffffffffc0205666 <do_wait.part.1+0x134>
        intr_disable();
ffffffffc020568a:	fd1fa0ef          	jal	ra,ffffffffc020065a <intr_disable>
        return 1;
ffffffffc020568e:	4585                	li	a1,1
ffffffffc0205690:	bf81                	j	ffffffffc02055e0 <do_wait.part.1+0xae>
        panic("wait idleproc or initproc.\n");
ffffffffc0205692:	00003617          	auipc	a2,0x3
ffffffffc0205696:	f8e60613          	addi	a2,a2,-114 # ffffffffc0208620 <default_pmm_manager+0x12b0>
ffffffffc020569a:	30100593          	li	a1,769
ffffffffc020569e:	00003517          	auipc	a0,0x3
ffffffffc02056a2:	1ca50513          	addi	a0,a0,458 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc02056a6:	ddffa0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02056aa:	00002617          	auipc	a2,0x2
ffffffffc02056ae:	d7660613          	addi	a2,a2,-650 # ffffffffc0207420 <default_pmm_manager+0xb0>
ffffffffc02056b2:	06200593          	li	a1,98
ffffffffc02056b6:	00002517          	auipc	a0,0x2
ffffffffc02056ba:	d3250513          	addi	a0,a0,-718 # ffffffffc02073e8 <default_pmm_manager+0x78>
ffffffffc02056be:	dc7fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    return pa2page(PADDR(kva));
ffffffffc02056c2:	00002617          	auipc	a2,0x2
ffffffffc02056c6:	d3660613          	addi	a2,a2,-714 # ffffffffc02073f8 <default_pmm_manager+0x88>
ffffffffc02056ca:	06e00593          	li	a1,110
ffffffffc02056ce:	00002517          	auipc	a0,0x2
ffffffffc02056d2:	d1a50513          	addi	a0,a0,-742 # ffffffffc02073e8 <default_pmm_manager+0x78>
ffffffffc02056d6:	daffa0ef          	jal	ra,ffffffffc0200484 <__panic>
...
ffffffffc02056dc:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02056de:	843fc0ef          	jal	ra,ffffffffc0201f20 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc02056e2:	d70fc0ef          	jal	ra,ffffffffc0201c52 <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc02056e6:	4601                	li	a2,0
ffffffffc02056e8:	4581                	li	a1,0
ffffffffc02056ea:	fffff517          	auipc	a0,0xfffff
ffffffffc02056ee:	64e50513          	addi	a0,a0,1614 # ffffffffc0204d38 <user_main>
ffffffffc02056f2:	ca3ff0ef          	jal	ra,ffffffffc0205394 <kernel_thread>
    if (pid <= 0) {
ffffffffc02056f6:	00a04563          	bgtz	a0,ffffffffc0205700 <init_main+0x26>
ffffffffc02056fa:	a841                	j	ffffffffc020578a <init_main+0xb0>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc02056fc:	0ef000ef          	jal	ra,ffffffffc0205fea <schedule>
    if (code_store != NULL) {
ffffffffc0205700:	4581                	li	a1,0
ffffffffc0205702:	4501                	li	a0,0
ffffffffc0205704:	e2fff0ef          	jal	ra,ffffffffc0205532 <do_wait.part.1>
    while (do_wait(0, NULL) == 0) {
...
ffffffffc020570e:	f5650513          	addi	a0,a0,-170 # ffffffffc0208660 <default_pmm_manager+0x12f0>
ffffffffc0205712:	a7dfa0ef          	jal	ra,ffffffffc020018e <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0205716:	000a7797          	auipc	a5,0xa7
ffffffffc020571a:	e5a78793          	addi	a5,a5,-422 # ffffffffc02ac570 <initproc>
ffffffffc020571e:	639c                	ld	a5,0(a5)
ffffffffc0205720:	7bf8                	ld	a4,240(a5)
ffffffffc0205722:	e721                	bnez	a4,ffffffffc020576a <init_main+0x90>
ffffffffc0205724:	7ff8                	ld	a4,248(a5)
ffffffffc0205726:	e331                	bnez	a4,ffffffffc020576a <init_main+0x90>
ffffffffc0205728:	1007b703          	ld	a4,256(a5)
ffffffffc020572c:	ef1d                	bnez	a4,ffffffffc020576a <init_main+0x90>
    assert(nr_process == 2);
ffffffffc020572e:	000a7717          	auipc	a4,0xa7
ffffffffc0205732:	e4a70713          	addi	a4,a4,-438 # ffffffffc02ac578 <nr_process>
ffffffffc0205736:	4314                	lw	a3,0(a4)
ffffffffc0205738:	4709                	li	a4,2
ffffffffc020573a:	0ae69463          	bne	a3,a4,ffffffffc02057e2 <init_main+0x108>
    return listelm->next;
ffffffffc020573e:	000a7697          	auipc	a3,0xa7
ffffffffc0205742:	f6268693          	addi	a3,a3,-158 # ffffffffc02ac6a0 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc0205746:	6698                	ld	a4,8(a3)
ffffffffc0205748:	0c878793          	addi	a5,a5,200
ffffffffc020574c:	06f71b63          	bne	a4,a5,ffffffffc02057c2 <init_main+0xe8>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0205750:	629c                	ld	a5,0(a3)
ffffffffc0205752:	04f71863          	bne	a4,a5,ffffffffc02057a2 <init_main+0xc8>

    cprintf("init check memory pass.\n");
ffffffffc0205756:	00003517          	auipc	a0,0x3
ffffffffc020575a:	ff250513          	addi	a0,a0,-14 # ffffffffc0208748 <default_pmm_manager+0x13d8>
ffffffffc020575e:	a31fa0ef          	jal	ra,ffffffffc020018e <cprintf>
    return 0;
}
ffffffffc0205762:	60a2                	ld	ra,8(sp)
ffffffffc0205764:	4501                	li	a0,0
ffffffffc0205766:	0141                	addi	sp,sp,16
ffffffffc0205768:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc020576a:	00003697          	auipc	a3,0x3
ffffffffc020576e:	f1e68693          	addi	a3,a3,-226 # ffffffffc0208688 <default_pmm_manager+0x1318>
ffffffffc0205772:	00001617          	auipc	a2,0x1
ffffffffc0205776:	4b660613          	addi	a2,a2,1206 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc020577a:	36600593          	li	a1,870
ffffffffc020577e:	00003517          	auipc	a0,0x3
ffffffffc0205782:	0ea50513          	addi	a0,a0,234 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205786:	cfffa0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("create user_main failed.\n");
ffffffffc020578a:	00003617          	auipc	a2,0x3
ffffffffc020578e:	eb660613          	addi	a2,a2,-330 # ffffffffc0208640 <default_pmm_manager+0x12d0>
ffffffffc0205792:	35e00593          	li	a1,862
ffffffffc0205796:	00003517          	auipc	a0,0x3
ffffffffc020579a:	0d250513          	addi	a0,a0,210 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc020579e:	ce7fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02057a2:	00003697          	auipc	a3,0x3
ffffffffc02057a6:	f7668693          	addi	a3,a3,-138 # ffffffffc0208718 <default_pmm_manager+0x13a8>
ffffffffc02057aa:	00001617          	auipc	a2,0x1
ffffffffc02057ae:	47e60613          	addi	a2,a2,1150 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc02057b2:	36900593          	li	a1,873
ffffffffc02057b6:	00003517          	auipc	a0,0x3
ffffffffc02057ba:	0b250513          	addi	a0,a0,178 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc02057be:	cc7fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02057c2:	00003697          	auipc	a3,0x3
ffffffffc02057c6:	f2668693          	addi	a3,a3,-218 # ffffffffc02086e8 <default_pmm_manager+0x1378>
ffffffffc02057ca:	00001617          	auipc	a2,0x1
ffffffffc02057ce:	45e60613          	addi	a2,a2,1118 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc02057d2:	36800593          	li	a1,872
ffffffffc02057d6:	00003517          	auipc	a0,0x3
ffffffffc02057da:	09250513          	addi	a0,a0,146 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc02057de:	ca7fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(nr_process == 2);
ffffffffc02057e2:	00003697          	auipc	a3,0x3
ffffffffc02057e6:	ef668693          	addi	a3,a3,-266 # ffffffffc02086d8 <default_pmm_manager+0x1368>
ffffffffc02057ea:	00001617          	auipc	a2,0x1
ffffffffc02057ee:	43e60613          	addi	a2,a2,1086 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc02057f2:	36700593          	li	a1,871
ffffffffc02057f6:	00003517          	auipc	a0,0x3
ffffffffc02057fa:	07250513          	addi	a0,a0,114 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc02057fe:	c87fa0ef          	jal	ra,ffffffffc0200484 <__panic>

ffffffffc0205802 <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205802:	7135                	addi	sp,sp,-160
ffffffffc0205804:	f8d2                	sd	s4,112(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205806:	000a7a17          	auipc	s4,0xa7
ffffffffc020580a:	d5aa0a13          	addi	s4,s4,-678 # ffffffffc02ac560 <current>
ffffffffc020580e:	000a3783          	ld	a5,0(s4)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205812:	e14a                	sd	s2,128(sp)
ffffffffc0205814:	e922                	sd	s0,144(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205816:	0287b903          	ld	s2,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020581a:	fcce                	sd	s3,120(sp)
ffffffffc020581c:	f0da                	sd	s6,96(sp)
ffffffffc020581e:	89aa                	mv	s3,a0
ffffffffc0205820:	842e                	mv	s0,a1
ffffffffc0205822:	8b32                	mv	s6,a2
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205824:	4681                	li	a3,0
ffffffffc0205826:	862e                	mv	a2,a1
ffffffffc0205828:	85aa                	mv	a1,a0
ffffffffc020582a:	854a                	mv	a0,s2
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020582c:	ed06                	sd	ra,152(sp)
ffffffffc020582e:	e526                	sd	s1,136(sp)
ffffffffc0205830:	f4d6                	sd	s5,104(sp)
ffffffffc0205832:	ecde                	sd	s7,88(sp)
ffffffffc0205834:	e8e2                	sd	s8,80(sp)
ffffffffc0205836:	e4e6                	sd	s9,72(sp)
ffffffffc0205838:	e0ea                	sd	s10,64(sp)
ffffffffc020583a:	fc6e                	sd	s11,56(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc020583c:	a74ff0ef          	jal	ra,ffffffffc0204ab0 <user_mem_check>
ffffffffc0205840:	40050663          	beqz	a0,ffffffffc0205c4c <do_execve+0x44a>
    memset(local_name, 0, sizeof(local_name));
ffffffffc0205844:	4641                	li	a2,16
ffffffffc0205846:	4581                	li	a1,0
ffffffffc0205848:	1008                	addi	a0,sp,32
ffffffffc020584a:	5c5000ef          	jal	ra,ffffffffc020660e <memset>
    memcpy(local_name, name, len);
ffffffffc020584e:	47bd                	li	a5,15
ffffffffc0205850:	8622                	mv	a2,s0
ffffffffc0205852:	0687ee63          	bltu	a5,s0,ffffffffc02058ce <do_execve+0xcc>
ffffffffc0205856:	85ce                	mv	a1,s3
ffffffffc0205858:	1008                	addi	a0,sp,32
ffffffffc020585a:	5c7000ef          	jal	ra,ffffffffc0206620 <memcpy>
    if (mm != NULL) {
ffffffffc020585e:	06090f63          	beqz	s2,ffffffffc02058dc <do_execve+0xda>
        cputs("mm != NULL");
ffffffffc0205862:	00002517          	auipc	a0,0x2
ffffffffc0205866:	2fe50513          	addi	a0,a0,766 # ffffffffc0207b60 <default_pmm_manager+0x7f0>
ffffffffc020586a:	95dfa0ef          	jal	ra,ffffffffc02001c6 <cputs>
        lcr3(boot_cr3);
ffffffffc020586e:	000a7797          	auipc	a5,0xa7
ffffffffc0205872:	d4278793          	addi	a5,a5,-702 # ffffffffc02ac5b0 <boot_cr3>
ffffffffc0205876:	639c                	ld	a5,0(a5)
ffffffffc0205878:	577d                	li	a4,-1
ffffffffc020587a:	177e                	slli	a4,a4,0x3f
ffffffffc020587c:	83b1                	srli	a5,a5,0xc
ffffffffc020587e:	8fd9                	or	a5,a5,a4
ffffffffc0205880:	18079073          	csrw	satp,a5
ffffffffc0205884:	03092783          	lw	a5,48(s2)
ffffffffc0205888:	fff7871b          	addiw	a4,a5,-1
ffffffffc020588c:	02e92823          	sw	a4,48(s2)
        if (mm_count_dec(mm) == 0) {
ffffffffc0205890:	28070d63          	beqz	a4,ffffffffc0205b2a <do_execve+0x328>
        current->mm = NULL;
ffffffffc0205894:	000a3783          	ld	a5,0(s4)
ffffffffc0205898:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {
ffffffffc020589c:	82bfe0ef          	jal	ra,ffffffffc02040c6 <mm_create>
ffffffffc02058a0:	892a                	mv	s2,a0
ffffffffc02058a2:	c135                	beqz	a0,ffffffffc0205906 <do_execve+0x104>
    if (setup_pgdir(mm) != 0) {
ffffffffc02058a4:	d94ff0ef          	jal	ra,ffffffffc0204e38 <setup_pgdir>
ffffffffc02058a8:	e931                	bnez	a0,ffffffffc02058fc <do_execve+0xfa>
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc02058aa:	000b2703          	lw	a4,0(s6)
ffffffffc02058ae:	464c47b7          	lui	a5,0x464c4
ffffffffc02058b2:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9aef>
ffffffffc02058b6:	04f70a63          	beq	a4,a5,ffffffffc020590a <do_execve+0x108>
    put_pgdir(mm);
ffffffffc02058ba:	854a                	mv	a0,s2
ffffffffc02058bc:	cfeff0ef          	jal	ra,ffffffffc0204dba <put_pgdir>
    mm_destroy(mm);
ffffffffc02058c0:	854a                	mv	a0,s2
ffffffffc02058c2:	98bfe0ef          	jal	ra,ffffffffc020424c <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc02058c6:	59e1                	li	s3,-8
    do_exit(ret);
ffffffffc02058c8:	854e                	mv	a0,s3
ffffffffc02058ca:	b1bff0ef          	jal	ra,ffffffffc02053e4 <do_exit>
    memcpy(local_name, name, len);
ffffffffc02058ce:	463d                	li	a2,15
ffffffffc02058d0:	85ce                	mv	a1,s3
ffffffffc02058d2:	1008                	addi	a0,sp,32
ffffffffc02058d4:	54d000ef          	jal	ra,ffffffffc0206620 <memcpy>
    if (mm != NULL) {
ffffffffc02058d8:	f80915e3          	bnez	s2,ffffffffc0205862 <do_execve+0x60>
    if (current->mm != NULL) {
ffffffffc02058dc:	000a3783          	ld	a5,0(s4)
ffffffffc02058e0:	779c                	ld	a5,40(a5)
ffffffffc02058e2:	dfcd                	beqz	a5,ffffffffc020589c <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc02058e4:	00003617          	auipc	a2,0x3
ffffffffc02058e8:	b2c60613          	addi	a2,a2,-1236 # ffffffffc0208410 <default_pmm_manager+0x10a0>
ffffffffc02058ec:	21100593          	li	a1,529
ffffffffc02058f0:	00003517          	auipc	a0,0x3
ffffffffc02058f4:	f7850513          	addi	a0,a0,-136 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc02058f8:	b8dfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    mm_destroy(mm);
ffffffffc02058fc:	854a                	mv	a0,s2
ffffffffc02058fe:	94ffe0ef          	jal	ra,ffffffffc020424c <mm_destroy>
    int ret = -E_NO_MEM;
ffffffffc0205902:	59f1                	li	s3,-4
ffffffffc0205904:	b7d1                	j	ffffffffc02058c8 <do_execve+0xc6>
ffffffffc0205906:	59f1                	li	s3,-4
ffffffffc0205908:	b7c1                	j	ffffffffc02058c8 <do_execve+0xc6>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020590a:	038b5703          	lhu	a4,56(s6)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc020590e:	020b3403          	ld	s0,32(s6)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205912:	00371793          	slli	a5,a4,0x3
ffffffffc0205916:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0205918:	945a                	add	s0,s0,s6
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020591a:	078e                	slli	a5,a5,0x3
ffffffffc020591c:	97a2                	add	a5,a5,s0
ffffffffc020591e:	ec3e                	sd	a5,24(sp)
    for (; ph < ph_end; ph ++) {
ffffffffc0205920:	02f47b63          	bleu	a5,s0,ffffffffc0205956 <do_execve+0x154>
    return KADDR(page2pa(page));
ffffffffc0205924:	5bfd                	li	s7,-1
ffffffffc0205926:	00cbd793          	srli	a5,s7,0xc
    return page - pages + nbase;
ffffffffc020592a:	000a7d97          	auipc	s11,0xa7
ffffffffc020592e:	c8ed8d93          	addi	s11,s11,-882 # ffffffffc02ac5b8 <pages>
ffffffffc0205932:	00003d17          	auipc	s10,0x3
ffffffffc0205936:	3fed0d13          	addi	s10,s10,1022 # ffffffffc0208d30 <nbase>
    return KADDR(page2pa(page));
ffffffffc020593a:	e43e                	sd	a5,8(sp)
ffffffffc020593c:	000a7c97          	auipc	s9,0xa7
ffffffffc0205940:	c0cc8c93          	addi	s9,s9,-1012 # ffffffffc02ac548 <npage>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc0205944:	4018                	lw	a4,0(s0)
ffffffffc0205946:	4785                	li	a5,1
ffffffffc0205948:	0ef70f63          	beq	a4,a5,ffffffffc0205a46 <do_execve+0x244>
    for (; ph < ph_end; ph ++) {
ffffffffc020594c:	67e2                	ld	a5,24(sp)
ffffffffc020594e:	03840413          	addi	s0,s0,56
ffffffffc0205952:	fef469e3          	bltu	s0,a5,ffffffffc0205944 <do_execve+0x142>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc0205956:	4701                	li	a4,0
ffffffffc0205958:	46ad                	li	a3,11
ffffffffc020595a:	00100637          	lui	a2,0x100
ffffffffc020595e:	7ff005b7          	lui	a1,0x7ff00
ffffffffc0205962:	854a                	mv	a0,s2
ffffffffc0205964:	93bfe0ef          	jal	ra,ffffffffc020429e <mm_map>
ffffffffc0205968:	89aa                	mv	s3,a0
ffffffffc020596a:	1a051663          	bnez	a0,ffffffffc0205b16 <do_execve+0x314>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc020596e:	01893503          	ld	a0,24(s2)
ffffffffc0205972:	467d                	li	a2,31
ffffffffc0205974:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc0205978:	981fd0ef          	jal	ra,ffffffffc02032f8 <pgdir_alloc_page>
ffffffffc020597c:	36050463          	beqz	a0,ffffffffc0205ce4 <do_execve+0x4e2>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205980:	01893503          	ld	a0,24(s2)
ffffffffc0205984:	467d                	li	a2,31
ffffffffc0205986:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc020598a:	96ffd0ef          	jal	ra,ffffffffc02032f8 <pgdir_alloc_page>
ffffffffc020598e:	32050b63          	beqz	a0,ffffffffc0205cc4 <do_execve+0x4c2>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205992:	01893503          	ld	a0,24(s2)
ffffffffc0205996:	467d                	li	a2,31
ffffffffc0205998:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc020599c:	95dfd0ef          	jal	ra,ffffffffc02032f8 <pgdir_alloc_page>
ffffffffc02059a0:	30050263          	beqz	a0,ffffffffc0205ca4 <do_execve+0x4a2>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc02059a4:	01893503          	ld	a0,24(s2)
ffffffffc02059a8:	467d                	li	a2,31
ffffffffc02059aa:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc02059ae:	94bfd0ef          	jal	ra,ffffffffc02032f8 <pgdir_alloc_page>
ffffffffc02059b2:	2c050963          	beqz	a0,ffffffffc0205c84 <do_execve+0x482>
    mm->mm_count += 1;
ffffffffc02059b6:	03092783          	lw	a5,48(s2)
    current->mm = mm;
ffffffffc02059ba:	000a3603          	ld	a2,0(s4)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02059be:	01893683          	ld	a3,24(s2)
ffffffffc02059c2:	2785                	addiw	a5,a5,1
ffffffffc02059c4:	02f92823          	sw	a5,48(s2)
    current->mm = mm;
ffffffffc02059c8:	03263423          	sd	s2,40(a2) # 100028 <_binary_obj___user_exit_out_size+0xf5598>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02059cc:	c02007b7          	lui	a5,0xc0200
ffffffffc02059d0:	28f6ee63          	bltu	a3,a5,ffffffffc0205c6c <do_execve+0x46a>
ffffffffc02059d4:	000a7797          	auipc	a5,0xa7
ffffffffc02059d8:	bd478793          	addi	a5,a5,-1068 # ffffffffc02ac5a8 <va_pa_offset>
ffffffffc02059dc:	639c                	ld	a5,0(a5)
ffffffffc02059de:	577d                	li	a4,-1
ffffffffc02059e0:	177e                	slli	a4,a4,0x3f
ffffffffc02059e2:	8e9d                	sub	a3,a3,a5
ffffffffc02059e4:	00c6d793          	srli	a5,a3,0xc
ffffffffc02059e8:	f654                	sd	a3,168(a2)
ffffffffc02059ea:	8fd9                	or	a5,a5,a4
ffffffffc02059ec:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc02059f0:	7240                	ld	s0,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02059f2:	4581                	li	a1,0
ffffffffc02059f4:	12000613          	li	a2,288
ffffffffc02059f8:	8522                	mv	a0,s0
ffffffffc02059fa:	415000ef          	jal	ra,ffffffffc020660e <memset>
    tf->epc = elf->e_entry;
ffffffffc02059fe:	018b3703          	ld	a4,24(s6)
    tf->gpr.sp = USTACKTOP;
ffffffffc0205a02:	4785                	li	a5,1
...
ffffffffc0205a0c:	100027f3          	csrr	a5,sstatus
ffffffffc0205a10:	edf7f793          	andi	a5,a5,-289
    set_proc_name(current, local_name);
ffffffffc0205a14:	000a3503          	ld	a0,0(s4)
    tf->status = (read_csr(sstatus) | SSTATUS_SPIE ) & ~SSTATUS_SPP;
ffffffffc0205a18:	0207e793          	ori	a5,a5,32
ffffffffc0205a1c:	10f43023          	sd	a5,256(s0)
    set_proc_name(current, local_name);
ffffffffc0205a20:	100c                	addi	a1,sp,32
ffffffffc0205a22:	ca2ff0ef          	jal	ra,ffffffffc0204ec4 <set_proc_name>
}
ffffffffc0205a26:	60ea                	ld	ra,152(sp)
ffffffffc0205a28:	644a                	ld	s0,144(sp)
ffffffffc0205a2a:	854e                	mv	a0,s3
ffffffffc0205a2c:	64aa                	ld	s1,136(sp)
ffffffffc0205a2e:	690a                	ld	s2,128(sp)
ffffffffc0205a30:	79e6                	ld	s3,120(sp)
ffffffffc0205a32:	7a46                	ld	s4,112(sp)
ffffffffc0205a34:	7aa6                	ld	s5,104(sp)
ffffffffc0205a36:	7b06                	ld	s6,96(sp)
ffffffffc0205a38:	6be6                	ld	s7,88(sp)
ffffffffc0205a3a:	6c46                	ld	s8,80(sp)
ffffffffc0205a3c:	6ca6                	ld	s9,72(sp)
ffffffffc0205a3e:	6d06                	ld	s10,64(sp)
ffffffffc0205a40:	7de2                	ld	s11,56(sp)
ffffffffc0205a42:	610d                	addi	sp,sp,160
ffffffffc0205a44:	8082                	ret
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc0205a46:	7410                	ld	a2,40(s0)
ffffffffc0205a48:	701c                	ld	a5,32(s0)
ffffffffc0205a4a:	20f66363          	bltu	a2,a5,ffffffffc0205c50 <do_execve+0x44e>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc0205a4e:	405c                	lw	a5,4(s0)
ffffffffc0205a50:	0017f693          	andi	a3,a5,1
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205a54:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc0205a58:	068a                	slli	a3,a3,0x2
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205a5a:	0e071263          	bnez	a4,ffffffffc0205b3e <do_execve+0x33c>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0205a5e:	4745                	li	a4,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a60:	8b91                	andi	a5,a5,4
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0205a62:	e03a                	sd	a4,0(sp)
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a64:	c789                	beqz	a5,ffffffffc0205a6e <do_execve+0x26c>
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc0205a66:	47cd                	li	a5,19
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a68:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc0205a6c:	e03e                	sd	a5,0(sp)
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a6e:	0026f793          	andi	a5,a3,2
ffffffffc0205a72:	efe1                	bnez	a5,ffffffffc0205b4a <do_execve+0x348>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc0205a74:	0046f793          	andi	a5,a3,4
ffffffffc0205a78:	c789                	beqz	a5,ffffffffc0205a82 <do_execve+0x280>
ffffffffc0205a7a:	6782                	ld	a5,0(sp)
ffffffffc0205a7c:	0087e793          	ori	a5,a5,8
ffffffffc0205a80:	e03e                	sd	a5,0(sp)
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc0205a82:	680c                	ld	a1,16(s0)
ffffffffc0205a84:	4701                	li	a4,0
ffffffffc0205a86:	854a                	mv	a0,s2
ffffffffc0205a88:	817fe0ef          	jal	ra,ffffffffc020429e <mm_map>
ffffffffc0205a8c:	89aa                	mv	s3,a0
ffffffffc0205a8e:	e541                	bnez	a0,ffffffffc0205b16 <do_execve+0x314>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a90:	01043b83          	ld	s7,16(s0)
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a94:	02043983          	ld	s3,32(s0)
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a98:	00843a83          	ld	s5,8(s0)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a9c:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a9e:	99de                	add	s3,s3,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205aa0:	9ada                	add	s5,s5,s6
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205aa2:	00fbfc33          	and	s8,s7,a5
        while (start < end) {
ffffffffc0205aa6:	053bef63          	bltu	s7,s3,ffffffffc0205b04 <do_execve+0x302>
ffffffffc0205aaa:	aa79                	j	ffffffffc0205c48 <do_execve+0x446>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205aac:	6785                	lui	a5,0x1
ffffffffc0205aae:	418b8533          	sub	a0,s7,s8
ffffffffc0205ab2:	9c3e                	add	s8,s8,a5
ffffffffc0205ab4:	417c0833          	sub	a6,s8,s7
            if (end < la) {
ffffffffc0205ab8:	0189f463          	bleu	s8,s3,ffffffffc0205ac0 <do_execve+0x2be>
                size -= la - end;
ffffffffc0205abc:	41798833          	sub	a6,s3,s7
    return page - pages + nbase;
ffffffffc0205ac0:	000db683          	ld	a3,0(s11)
ffffffffc0205ac4:	000d3583          	ld	a1,0(s10)
    return KADDR(page2pa(page));
ffffffffc0205ac8:	67a2                	ld	a5,8(sp)
    return page - pages + nbase;
ffffffffc0205aca:	40d486b3          	sub	a3,s1,a3
ffffffffc0205ace:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205ad0:	000cb603          	ld	a2,0(s9)
    return page - pages + nbase;
ffffffffc0205ad4:	96ae                	add	a3,a3,a1
    return KADDR(page2pa(page));
ffffffffc0205ad6:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205ada:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205adc:	16c5fc63          	bleu	a2,a1,ffffffffc0205c54 <do_execve+0x452>
ffffffffc0205ae0:	000a7797          	auipc	a5,0xa7
ffffffffc0205ae4:	ac878793          	addi	a5,a5,-1336 # ffffffffc02ac5a8 <va_pa_offset>
ffffffffc0205ae8:	0007b883          	ld	a7,0(a5)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205aec:	85d6                	mv	a1,s5
ffffffffc0205aee:	8642                	mv	a2,a6
ffffffffc0205af0:	96c6                	add	a3,a3,a7
ffffffffc0205af2:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205af4:	9bc2                	add	s7,s7,a6
ffffffffc0205af6:	e842                	sd	a6,16(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205af8:	329000ef          	jal	ra,ffffffffc0206620 <memcpy>
            start += size, from += size;
ffffffffc0205afc:	6842                	ld	a6,16(sp)
ffffffffc0205afe:	9ac2                	add	s5,s5,a6
        while (start < end) {
ffffffffc0205b00:	053bf863          	bleu	s3,s7,ffffffffc0205b50 <do_execve+0x34e>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205b04:	01893503          	ld	a0,24(s2)
ffffffffc0205b08:	6602                	ld	a2,0(sp)
ffffffffc0205b0a:	85e2                	mv	a1,s8
ffffffffc0205b0c:	fecfd0ef          	jal	ra,ffffffffc02032f8 <pgdir_alloc_page>
ffffffffc0205b10:	84aa                	mv	s1,a0
ffffffffc0205b12:	fd49                	bnez	a0,ffffffffc0205aac <do_execve+0x2aa>
        ret = -E_NO_MEM;
ffffffffc0205b14:	59f1                	li	s3,-4
    exit_mmap(mm);
ffffffffc0205b16:	854a                	mv	a0,s2
ffffffffc0205b18:	8d5fe0ef          	jal	ra,ffffffffc02043ec <exit_mmap>
    put_pgdir(mm);
ffffffffc0205b1c:	854a                	mv	a0,s2
ffffffffc0205b1e:	a9cff0ef          	jal	ra,ffffffffc0204dba <put_pgdir>
    mm_destroy(mm);
ffffffffc0205b22:	854a                	mv	a0,s2
ffffffffc0205b24:	f28fe0ef          	jal	ra,ffffffffc020424c <mm_destroy>
    return ret;
ffffffffc0205b28:	b345                	j	ffffffffc02058c8 <do_execve+0xc6>
            exit_mmap(mm);
ffffffffc0205b2a:	854a                	mv	a0,s2
ffffffffc0205b2c:	8c1fe0ef          	jal	ra,ffffffffc02043ec <exit_mmap>
            put_pgdir(mm);
ffffffffc0205b30:	854a                	mv	a0,s2
ffffffffc0205b32:	a88ff0ef          	jal	ra,ffffffffc0204dba <put_pgdir>
            mm_destroy(mm);
ffffffffc0205b36:	854a                	mv	a0,s2
ffffffffc0205b38:	f14fe0ef          	jal	ra,ffffffffc020424c <mm_destroy>
ffffffffc0205b3c:	bba1                	j	ffffffffc0205894 <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205b3e:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205b42:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205b44:	2681                	sext.w	a3,a3
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205b46:	f20790e3          	bnez	a5,ffffffffc0205a66 <do_execve+0x264>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205b4a:	47dd                	li	a5,23
ffffffffc0205b4c:	e03e                	sd	a5,0(sp)
ffffffffc0205b4e:	b71d                	j	ffffffffc0205a74 <do_execve+0x272>
ffffffffc0205b50:	01043983          	ld	s3,16(s0)
        end = ph->p_va + ph->p_memsz;
ffffffffc0205b54:	7414                	ld	a3,40(s0)
ffffffffc0205b56:	99b6                	add	s3,s3,a3
        if (start < la) {
ffffffffc0205b58:	098bf163          	bleu	s8,s7,ffffffffc0205bda <do_execve+0x3d8>
            if (start == end) {
ffffffffc0205b5c:	df7988e3          	beq	s3,s7,ffffffffc020594c <do_execve+0x14a>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205b60:	6505                	lui	a0,0x1
ffffffffc0205b62:	955e                	add	a0,a0,s7
ffffffffc0205b64:	41850533          	sub	a0,a0,s8
                size -= la - end;
ffffffffc0205b68:	41798ab3          	sub	s5,s3,s7
            if (end < la) {
ffffffffc0205b6c:	0d89fb63          	bleu	s8,s3,ffffffffc0205c42 <do_execve+0x440>
    return page - pages + nbase;
ffffffffc0205b70:	000db683          	ld	a3,0(s11)
ffffffffc0205b74:	000d3583          	ld	a1,0(s10)
    return KADDR(page2pa(page));
ffffffffc0205b78:	67a2                	ld	a5,8(sp)
    return page - pages + nbase;
ffffffffc0205b7a:	40d486b3          	sub	a3,s1,a3
ffffffffc0205b7e:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205b80:	000cb603          	ld	a2,0(s9)
    return page - pages + nbase;
ffffffffc0205b84:	96ae                	add	a3,a3,a1
    return KADDR(page2pa(page));
ffffffffc0205b86:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b8a:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b8c:	0cc5f463          	bleu	a2,a1,ffffffffc0205c54 <do_execve+0x452>
ffffffffc0205b90:	000a7617          	auipc	a2,0xa7
ffffffffc0205b94:	a1860613          	addi	a2,a2,-1512 # ffffffffc02ac5a8 <va_pa_offset>
ffffffffc0205b98:	00063803          	ld	a6,0(a2)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b9c:	4581                	li	a1,0
ffffffffc0205b9e:	8656                	mv	a2,s5
ffffffffc0205ba0:	96c2                	add	a3,a3,a6
ffffffffc0205ba2:	9536                	add	a0,a0,a3
ffffffffc0205ba4:	26b000ef          	jal	ra,ffffffffc020660e <memset>
            start += size;
ffffffffc0205ba8:	017a8733          	add	a4,s5,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205bac:	0389f463          	bleu	s8,s3,ffffffffc0205bd4 <do_execve+0x3d2>
ffffffffc0205bb0:	d8e98ee3          	beq	s3,a4,ffffffffc020594c <do_execve+0x14a>
ffffffffc0205bb4:	00003697          	auipc	a3,0x3
ffffffffc0205bb8:	88468693          	addi	a3,a3,-1916 # ffffffffc0208438 <default_pmm_manager+0x10c8>
ffffffffc0205bbc:	00001617          	auipc	a2,0x1
ffffffffc0205bc0:	06c60613          	addi	a2,a2,108 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc0205bc4:	26600593          	li	a1,614
ffffffffc0205bc8:	00003517          	auipc	a0,0x3
ffffffffc0205bcc:	ca050513          	addi	a0,a0,-864 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205bd0:	8b5fa0ef          	jal	ra,ffffffffc0200484 <__panic>
ffffffffc0205bd4:	ff8710e3          	bne	a4,s8,ffffffffc0205bb4 <do_execve+0x3b2>
ffffffffc0205bd8:	8be2                	mv	s7,s8
ffffffffc0205bda:	000a7a97          	auipc	s5,0xa7
ffffffffc0205bde:	9cea8a93          	addi	s5,s5,-1586 # ffffffffc02ac5a8 <va_pa_offset>
        while (start < end) {
ffffffffc0205be2:	053be763          	bltu	s7,s3,ffffffffc0205c30 <do_execve+0x42e>
ffffffffc0205be6:	b39d                	j	ffffffffc020594c <do_execve+0x14a>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205be8:	6785                	lui	a5,0x1
ffffffffc0205bea:	418b8533          	sub	a0,s7,s8
ffffffffc0205bee:	9c3e                	add	s8,s8,a5
ffffffffc0205bf0:	417c0633          	sub	a2,s8,s7
            if (end < la) {
ffffffffc0205bf4:	0189f463          	bleu	s8,s3,ffffffffc0205bfc <do_execve+0x3fa>
                size -= la - end;
ffffffffc0205bf8:	41798633          	sub	a2,s3,s7
    return page - pages + nbase;
ffffffffc0205bfc:	000db683          	ld	a3,0(s11)
ffffffffc0205c00:	000d3803          	ld	a6,0(s10)
    return KADDR(page2pa(page));
ffffffffc0205c04:	67a2                	ld	a5,8(sp)
    return page - pages + nbase;
ffffffffc0205c06:	40d486b3          	sub	a3,s1,a3
ffffffffc0205c0a:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205c0c:	000cb583          	ld	a1,0(s9)
    return page - pages + nbase;
ffffffffc0205c10:	96c2                	add	a3,a3,a6
    return KADDR(page2pa(page));
ffffffffc0205c12:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205c16:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205c18:	02b87e63          	bleu	a1,a6,ffffffffc0205c54 <do_execve+0x452>
ffffffffc0205c1c:	000ab803          	ld	a6,0(s5)
            start += size;
ffffffffc0205c20:	9bb2                	add	s7,s7,a2
            memset(page2kva(page) + off, 0, size);
ffffffffc0205c22:	4581                	li	a1,0
ffffffffc0205c24:	96c2                	add	a3,a3,a6
ffffffffc0205c26:	9536                	add	a0,a0,a3
ffffffffc0205c28:	1e7000ef          	jal	ra,ffffffffc020660e <memset>
        while (start < end) {
ffffffffc0205c2c:	d33bf0e3          	bleu	s3,s7,ffffffffc020594c <do_execve+0x14a>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205c30:	01893503          	ld	a0,24(s2)
ffffffffc0205c34:	6602                	ld	a2,0(sp)
ffffffffc0205c36:	85e2                	mv	a1,s8
ffffffffc0205c38:	ec0fd0ef          	jal	ra,ffffffffc02032f8 <pgdir_alloc_page>
ffffffffc0205c3c:	84aa                	mv	s1,a0
ffffffffc0205c3e:	f54d                	bnez	a0,ffffffffc0205be8 <do_execve+0x3e6>
ffffffffc0205c40:	bdd1                	j	ffffffffc0205b14 <do_execve+0x312>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205c42:	417c0ab3          	sub	s5,s8,s7
ffffffffc0205c46:	b72d                	j	ffffffffc0205b70 <do_execve+0x36e>
        while (start < end) {
ffffffffc0205c48:	89de                	mv	s3,s7
ffffffffc0205c4a:	b729                	j	ffffffffc0205b54 <do_execve+0x352>
        return -E_INVAL;
ffffffffc0205c4c:	59f5                	li	s3,-3
ffffffffc0205c4e:	bbe1                	j	ffffffffc0205a26 <do_execve+0x224>
            ret = -E_INVAL_ELF;
ffffffffc0205c50:	59e1                	li	s3,-8
ffffffffc0205c52:	b5d1                	j	ffffffffc0205b16 <do_execve+0x314>
ffffffffc0205c54:	00001617          	auipc	a2,0x1
ffffffffc0205c58:	76c60613          	addi	a2,a2,1900 # ffffffffc02073c0 <default_pmm_manager+0x50>
ffffffffc0205c5c:	06900593          	li	a1,105
ffffffffc0205c60:	00001517          	auipc	a0,0x1
ffffffffc0205c64:	78850513          	addi	a0,a0,1928 # ffffffffc02073e8 <default_pmm_manager+0x78>
ffffffffc0205c68:	81dfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205c6c:	00001617          	auipc	a2,0x1
ffffffffc0205c70:	78c60613          	addi	a2,a2,1932 # ffffffffc02073f8 <default_pmm_manager+0x88>
ffffffffc0205c74:	28100593          	li	a1,641
ffffffffc0205c78:	00003517          	auipc	a0,0x3
ffffffffc0205c7c:	bf050513          	addi	a0,a0,-1040 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205c80:	805fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c84:	00003697          	auipc	a3,0x3
ffffffffc0205c88:	8cc68693          	addi	a3,a3,-1844 # ffffffffc0208550 <default_pmm_manager+0x11e0>
ffffffffc0205c8c:	00001617          	auipc	a2,0x1
ffffffffc0205c90:	f9c60613          	addi	a2,a2,-100 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc0205c94:	27c00593          	li	a1,636
ffffffffc0205c98:	00003517          	auipc	a0,0x3
ffffffffc0205c9c:	bd050513          	addi	a0,a0,-1072 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205ca0:	fe4fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205ca4:	00003697          	auipc	a3,0x3
ffffffffc0205ca8:	86468693          	addi	a3,a3,-1948 # ffffffffc0208508 <default_pmm_manager+0x1198>
ffffffffc0205cac:	00001617          	auipc	a2,0x1
ffffffffc0205cb0:	f7c60613          	addi	a2,a2,-132 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc0205cb4:	27b00593          	li	a1,635
ffffffffc0205cb8:	00003517          	auipc	a0,0x3
ffffffffc0205cbc:	bb050513          	addi	a0,a0,-1104 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205cc0:	fc4fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205cc4:	00002697          	auipc	a3,0x2
ffffffffc0205cc8:	7fc68693          	addi	a3,a3,2044 # ffffffffc02084c0 <default_pmm_manager+0x1150>
ffffffffc0205ccc:	00001617          	auipc	a2,0x1
ffffffffc0205cd0:	f5c60613          	addi	a2,a2,-164 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc0205cd4:	27a00593          	li	a1,634
ffffffffc0205cd8:	00003517          	auipc	a0,0x3
ffffffffc0205cdc:	b9050513          	addi	a0,a0,-1136 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205ce0:	fa4fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205ce4:	00002697          	auipc	a3,0x2
ffffffffc0205ce8:	79468693          	addi	a3,a3,1940 # ffffffffc0208478 <default_pmm_manager+0x1108>
ffffffffc0205cec:	00001617          	auipc	a2,0x1
ffffffffc0205cf0:	f3c60613          	addi	a2,a2,-196 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc0205cf4:	27900593          	li	a1,633
ffffffffc0205cf8:	00003517          	auipc	a0,0x3
ffffffffc0205cfc:	b7050513          	addi	a0,a0,-1168 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205d00:	f84fa0ef          	jal	ra,ffffffffc0200484 <__panic>

ffffffffc0205d04 <do_yield>:
    current->need_resched = 1;
ffffffffc0205d04:	000a7797          	auipc	a5,0xa7
ffffffffc0205d08:	85c78793          	addi	a5,a5,-1956 # ffffffffc02ac560 <current>
ffffffffc0205d0c:	639c                	ld	a5,0(a5)
ffffffffc0205d0e:	4705                	li	a4,1
}
ffffffffc0205d10:	4501                	li	a0,0
    current->need_resched = 1;
ffffffffc0205d12:	ef98                	sd	a4,24(a5)
}
...
ffffffffc0205d20:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205d22:	cd81                	beqz	a1,ffffffffc0205d3a <do_wait+0x24>
    struct mm_struct *mm = current->mm;
ffffffffc0205d24:	000a7797          	auipc	a5,0xa7
ffffffffc0205d28:	83c78793          	addi	a5,a5,-1988 # ffffffffc02ac560 <current>
ffffffffc0205d2c:	639c                	ld	a5,0(a5)
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205d2e:	4685                	li	a3,1
ffffffffc0205d30:	4611                	li	a2,4
ffffffffc0205d32:	7788                	ld	a0,40(a5)
ffffffffc0205d34:	d7dfe0ef          	jal	ra,ffffffffc0204ab0 <user_mem_check>
ffffffffc0205d38:	c909                	beqz	a0,ffffffffc0205d4a <do_wait+0x34>
ffffffffc0205d3a:	85a2                	mv	a1,s0
}
ffffffffc0205d3c:	6442                	ld	s0,16(sp)
ffffffffc0205d3e:	60e2                	ld	ra,24(sp)
ffffffffc0205d40:	8526                	mv	a0,s1
ffffffffc0205d42:	64a2                	ld	s1,8(sp)
ffffffffc0205d44:	6105                	addi	sp,sp,32
ffffffffc0205d46:	fecff06f          	j	ffffffffc0205532 <do_wait.part.1>
ffffffffc0205d4a:	60e2                	ld	ra,24(sp)
ffffffffc0205d4c:	6442                	ld	s0,16(sp)
ffffffffc0205d4e:	64a2                	ld	s1,8(sp)
ffffffffc0205d50:	5575                	li	a0,-3
ffffffffc0205d52:	6105                	addi	sp,sp,32
ffffffffc0205d54:	8082                	ret

ffffffffc0205d56 <do_kill>:
do_kill(int pid) {
ffffffffc0205d56:	1141                	addi	sp,sp,-16
ffffffffc0205d58:	e406                	sd	ra,8(sp)
ffffffffc0205d5a:	e022                	sd	s0,0(sp)
    if ((proc = find_proc(pid)) != NULL) {
ffffffffc0205d5c:	9feff0ef          	jal	ra,ffffffffc0204f5a <find_proc>
ffffffffc0205d60:	cd0d                	beqz	a0,ffffffffc0205d9a <do_kill+0x44>
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205d62:	0b052703          	lw	a4,176(a0)
ffffffffc0205d66:	00177693          	andi	a3,a4,1
ffffffffc0205d6a:	e695                	bnez	a3,ffffffffc0205d96 <do_kill+0x40>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d6c:	0ec52683          	lw	a3,236(a0)
            proc->flags |= PF_EXITING;
ffffffffc0205d70:	00176713          	ori	a4,a4,1
ffffffffc0205d74:	0ae52823          	sw	a4,176(a0)
            return 0;
ffffffffc0205d78:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d7a:	0006c763          	bltz	a3,ffffffffc0205d88 <do_kill+0x32>
}
...
ffffffffc0205d86:	8082                	ret
                wakeup_proc(proc);
ffffffffc0205d88:	1e6000ef          	jal	ra,ffffffffc0205f6e <wakeup_proc>
}
...
ffffffffc0205d94:	8082                	ret
        return -E_KILLED;
ffffffffc0205d96:	545d                	li	s0,-9
ffffffffc0205d98:	b7dd                	j	ffffffffc0205d7e <do_kill+0x28>
    return -E_INVAL;
ffffffffc0205d9a:	5475                	li	s0,-3
ffffffffc0205d9c:	b7cd                	j	ffffffffc0205d7e <do_kill+0x28>

ffffffffc0205d9e <proc_init>:
    elm->prev = elm->next = elm;
ffffffffc0205d9e:	000a7797          	auipc	a5,0xa7
ffffffffc0205da2:	90278793          	addi	a5,a5,-1790 # ffffffffc02ac6a0 <proc_list>

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0205da6:	1101                	addi	sp,sp,-32
ffffffffc0205da8:	000a7717          	auipc	a4,0xa7
ffffffffc0205dac:	90f73023          	sd	a5,-1792(a4) # ffffffffc02ac6a8 <proc_list+0x8>
ffffffffc0205db0:	000a7717          	auipc	a4,0xa7
ffffffffc0205db4:	8ef73823          	sd	a5,-1808(a4) # ffffffffc02ac6a0 <proc_list>
ffffffffc0205db8:	ec06                	sd	ra,24(sp)
ffffffffc0205dba:	e822                	sd	s0,16(sp)
ffffffffc0205dbc:	e426                	sd	s1,8(sp)
ffffffffc0205dbe:	000a2797          	auipc	a5,0xa2
ffffffffc0205dc2:	76a78793          	addi	a5,a5,1898 # ffffffffc02a8528 <hash_list>
ffffffffc0205dc6:	000a6717          	auipc	a4,0xa6
ffffffffc0205dca:	76270713          	addi	a4,a4,1890 # ffffffffc02ac528 <is_panic>
ffffffffc0205dce:	e79c                	sd	a5,8(a5)
ffffffffc0205dd0:	e39c                	sd	a5,0(a5)
ffffffffc0205dd2:	07c1                	addi	a5,a5,16
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205dd4:	fee79de3          	bne	a5,a4,ffffffffc0205dce <proc_init+0x30>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205dd8:	eddfe0ef          	jal	ra,ffffffffc0204cb4 <alloc_proc>
ffffffffc0205ddc:	000a6717          	auipc	a4,0xa6
ffffffffc0205de0:	78a73623          	sd	a0,1932(a4) # ffffffffc02ac568 <idleproc>
ffffffffc0205de4:	000a6497          	auipc	s1,0xa6
ffffffffc0205de8:	78448493          	addi	s1,s1,1924 # ffffffffc02ac568 <idleproc>
ffffffffc0205dec:	c559                	beqz	a0,ffffffffc0205e7a <proc_init+0xdc>
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205dee:	4709                	li	a4,2
ffffffffc0205df0:	e118                	sd	a4,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
    idleproc->need_resched = 1;
ffffffffc0205df2:	4405                	li	s0,1
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205df4:	00003717          	auipc	a4,0x3
ffffffffc0205df8:	20c70713          	addi	a4,a4,524 # ffffffffc0209000 <bootstack>
    set_proc_name(idleproc, "idle");
ffffffffc0205dfc:	00003597          	auipc	a1,0x3
ffffffffc0205e00:	98458593          	addi	a1,a1,-1660 # ffffffffc0208780 <default_pmm_manager+0x1410>
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205e04:	e918                	sd	a4,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205e06:	ed00                	sd	s0,24(a0)
    set_proc_name(idleproc, "idle");
ffffffffc0205e08:	8bcff0ef          	jal	ra,ffffffffc0204ec4 <set_proc_name>
    nr_process ++;
ffffffffc0205e0c:	000a6797          	auipc	a5,0xa6
ffffffffc0205e10:	76c78793          	addi	a5,a5,1900 # ffffffffc02ac578 <nr_process>
ffffffffc0205e14:	439c                	lw	a5,0(a5)

    current = idleproc;
ffffffffc0205e16:	6098                	ld	a4,0(s1)
...
ffffffffc0205e22:	8bc50513          	addi	a0,a0,-1860 # ffffffffc02056da <init_main>
    nr_process ++;
ffffffffc0205e26:	000a6697          	auipc	a3,0xa6
ffffffffc0205e2a:	74f6a923          	sw	a5,1874(a3) # ffffffffc02ac578 <nr_process>
    current = idleproc;
ffffffffc0205e2e:	000a6797          	auipc	a5,0xa6
ffffffffc0205e32:	72e7b923          	sd	a4,1842(a5) # ffffffffc02ac560 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205e36:	d5eff0ef          	jal	ra,ffffffffc0205394 <kernel_thread>
    if (pid <= 0) {
ffffffffc0205e3a:	08a05c63          	blez	a0,ffffffffc0205ed2 <proc_init+0x134>
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205e3e:	91cff0ef          	jal	ra,ffffffffc0204f5a <find_proc>
    set_proc_name(initproc, "init");
ffffffffc0205e42:	00003597          	auipc	a1,0x3
ffffffffc0205e46:	96658593          	addi	a1,a1,-1690 # ffffffffc02087a8 <default_pmm_manager+0x1438>
    initproc = find_proc(pid);
ffffffffc0205e4a:	000a6797          	auipc	a5,0xa6
ffffffffc0205e4e:	72a7b323          	sd	a0,1830(a5) # ffffffffc02ac570 <initproc>
    set_proc_name(initproc, "init");
ffffffffc0205e52:	872ff0ef          	jal	ra,ffffffffc0204ec4 <set_proc_name>

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e56:	609c                	ld	a5,0(s1)
ffffffffc0205e58:	cfa9                	beqz	a5,ffffffffc0205eb2 <proc_init+0x114>
ffffffffc0205e5a:	43dc                	lw	a5,4(a5)
ffffffffc0205e5c:	ebb9                	bnez	a5,ffffffffc0205eb2 <proc_init+0x114>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e5e:	000a6797          	auipc	a5,0xa6
ffffffffc0205e62:	71278793          	addi	a5,a5,1810 # ffffffffc02ac570 <initproc>
ffffffffc0205e66:	639c                	ld	a5,0(a5)
ffffffffc0205e68:	c78d                	beqz	a5,ffffffffc0205e92 <proc_init+0xf4>
ffffffffc0205e6a:	43dc                	lw	a5,4(a5)
ffffffffc0205e6c:	02879363          	bne	a5,s0,ffffffffc0205e92 <proc_init+0xf4>
}
ffffffffc0205e70:	60e2                	ld	ra,24(sp)
ffffffffc0205e72:	6442                	ld	s0,16(sp)
ffffffffc0205e74:	64a2                	ld	s1,8(sp)
ffffffffc0205e76:	6105                	addi	sp,sp,32
ffffffffc0205e78:	8082                	ret
        panic("cannot alloc idleproc.\n");
ffffffffc0205e7a:	00003617          	auipc	a2,0x3
ffffffffc0205e7e:	8ee60613          	addi	a2,a2,-1810 # ffffffffc0208768 <default_pmm_manager+0x13f8>
ffffffffc0205e82:	37b00593          	li	a1,891
ffffffffc0205e86:	00003517          	auipc	a0,0x3
ffffffffc0205e8a:	9e250513          	addi	a0,a0,-1566 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205e8e:	df6fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e92:	00003697          	auipc	a3,0x3
ffffffffc0205e96:	94668693          	addi	a3,a3,-1722 # ffffffffc02087d8 <default_pmm_manager+0x1468>
ffffffffc0205e9a:	00001617          	auipc	a2,0x1
ffffffffc0205e9e:	d8e60613          	addi	a2,a2,-626 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc0205ea2:	39000593          	li	a1,912
ffffffffc0205ea6:	00003517          	auipc	a0,0x3
ffffffffc0205eaa:	9c250513          	addi	a0,a0,-1598 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205eae:	dd6fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205eb2:	00003697          	auipc	a3,0x3
ffffffffc0205eb6:	8fe68693          	addi	a3,a3,-1794 # ffffffffc02087b0 <default_pmm_manager+0x1440>
ffffffffc0205eba:	00001617          	auipc	a2,0x1
ffffffffc0205ebe:	d6e60613          	addi	a2,a2,-658 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc0205ec2:	38f00593          	li	a1,911
ffffffffc0205ec6:	00003517          	auipc	a0,0x3
ffffffffc0205eca:	9a250513          	addi	a0,a0,-1630 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205ece:	db6fa0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("create init_main failed.\n");
ffffffffc0205ed2:	00003617          	auipc	a2,0x3
ffffffffc0205ed6:	8b660613          	addi	a2,a2,-1866 # ffffffffc0208788 <default_pmm_manager+0x1418>
ffffffffc0205eda:	38900593          	li	a1,905
ffffffffc0205ede:	00003517          	auipc	a0,0x3
ffffffffc0205ee2:	98a50513          	addi	a0,a0,-1654 # ffffffffc0208868 <default_pmm_manager+0x14f8>
ffffffffc0205ee6:	d9efa0ef          	jal	ra,ffffffffc0200484 <__panic>
...
ffffffffc0205ef0:	000a6417          	auipc	s0,0xa6
ffffffffc0205ef4:	67040413          	addi	s0,s0,1648 # ffffffffc02ac560 <current>
    while (1) {
        if (current->need_resched) {
...
ffffffffc0205efc:	dffd                	beqz	a5,ffffffffc0205efa <cpu_idle+0x10>
            schedule();
ffffffffc0205efe:	0ec000ef          	jal	ra,ffffffffc0205fea <schedule>
...
ffffffffc0205fa0:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205fa2:	eb2fa06f          	j	ffffffffc0200654 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205fa6:	00003617          	auipc	a2,0x3
ffffffffc0205faa:	91260613          	addi	a2,a2,-1774 # ffffffffc02088b8 <default_pmm_manager+0x1548>
ffffffffc0205fae:	45c9                	li	a1,18
ffffffffc0205fb0:	00003517          	auipc	a0,0x3
ffffffffc0205fb4:	8f050513          	addi	a0,a0,-1808 # ffffffffc02088a0 <default_pmm_manager+0x1530>
ffffffffc0205fb8:	d38fa0ef          	jal	ra,ffffffffc02004f0 <__warn>
ffffffffc0205fbc:	bfd9                	j	ffffffffc0205f92 <wakeup_proc+0x24>
ffffffffc0205fbe:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0205fc0:	e9afa0ef          	jal	ra,ffffffffc020065a <intr_disable>
        return 1;
...
ffffffffc0205fd0:	8b468693          	addi	a3,a3,-1868 # ffffffffc0208880 <default_pmm_manager+0x1510>
ffffffffc0205fd4:	00001617          	auipc	a2,0x1
ffffffffc0205fd8:	c5460613          	addi	a2,a2,-940 # ffffffffc0206c28 <commands+0x4c0>
ffffffffc0205fdc:	45a5                	li	a1,9
ffffffffc0205fde:	00003517          	auipc	a0,0x3
ffffffffc0205fe2:	8c250513          	addi	a0,a0,-1854 # ffffffffc02088a0 <default_pmm_manager+0x1530>
ffffffffc0205fe6:	c9efa0ef          	jal	ra,ffffffffc0200484 <__panic>
...
ffffffffc0205ffe:	56678793          	addi	a5,a5,1382 # ffffffffc02ac560 <current>
ffffffffc0206002:	0007b883          	ld	a7,0(a5)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206006:	000a6797          	auipc	a5,0xa6
ffffffffc020600a:	56278793          	addi	a5,a5,1378 # ffffffffc02ac568 <idleproc>
ffffffffc020600e:	6388                	ld	a0,0(a5)
        current->need_resched = 0;
ffffffffc0206010:	0008bc23          	sd	zero,24(a7) # fffffffffff80018 <end+0x3fcd3968>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
...
ffffffffc0206020:	68460613          	addi	a2,a2,1668 # ffffffffc02ac6a0 <proc_list>
        le = last;
...
ffffffffc0206050:	00a88463          	beq	a7,a0,ffffffffc0206058 <schedule+0x6e>
            proc_run(next);
ffffffffc0206054:	e9bfe0ef          	jal	ra,ffffffffc0204eee <proc_run>
    if (flag) {
...
ffffffffc020606a:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc020606c:	de8fa06f          	j	ffffffffc0200654 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206070:	000a6617          	auipc	a2,0xa6
ffffffffc0206074:	63060613          	addi	a2,a2,1584 # ffffffffc02ac6a0 <proc_list>
ffffffffc0206078:	86b2                	mv	a3,a2
ffffffffc020607a:	b76d                	j	ffffffffc0206024 <schedule+0x3a>
        intr_disable();
ffffffffc020607c:	ddefa0ef          	jal	ra,ffffffffc020065a <intr_disable>
        return 1;
...
ffffffffc0206088:	4dc78793          	addi	a5,a5,1244 # ffffffffc02ac560 <current>
...
ffffffffc020609a:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc020609c:	926fa0ef          	jal	ra,ffffffffc02001c2 <cputchar>
}
...
ffffffffc02060aa:	cadff06f          	j	ffffffffc0205d56 <do_kill>

ffffffffc02060ae <sys_yield>:
    return do_yield();
ffffffffc02060ae:	c57ff06f          	j	ffffffffc0205d04 <do_yield>
...
ffffffffc02060ba:	f48ff06f          	j	ffffffffc0205802 <do_execve>

ffffffffc02060be <sys_wait>:
    return do_wait(pid, store);
ffffffffc02060be:	650c                	ld	a1,8(a0)
ffffffffc02060c0:	4108                	lw	a0,0(a0)
ffffffffc02060c2:	c55ff06f          	j	ffffffffc0205d16 <do_wait>

ffffffffc02060c6 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc02060c6:	000a6797          	auipc	a5,0xa6
ffffffffc02060ca:	49a78793          	addi	a5,a5,1178 # ffffffffc02ac560 <current>
...
ffffffffc02060d6:	ee1fe06f          	j	ffffffffc0204fb6 <do_fork>

ffffffffc02060da <sys_exit>:
    return do_exit(error_code);
ffffffffc02060da:	4108                	lw	a0,0(a0)
ffffffffc02060dc:	b08ff06f          	j	ffffffffc02053e4 <do_exit>
...
ffffffffc02060e8:	47c48493          	addi	s1,s1,1148 # ffffffffc02ac560 <current>
...
ffffffffc0206146:	79660613          	addi	a2,a2,1942 # ffffffffc02088d8 <default_pmm_manager+0x1568>
...
ffffffffc0206158:	7b450513          	addi	a0,a0,1972 # ffffffffc0208908 <default_pmm_manager+0x1598>
ffffffffc020615c:	b28fa0ef          	jal	ra,ffffffffc0200484 <__panic>

ffffffffc0206160 <hash32>:
 *
...
ffffffffc0206160:	9e3707b7          	lui	a5,0x9e370
ffffffffc0206164:	2785                	addiw	a5,a5,1
ffffffffc0206166:	02f5053b          	mulw	a0,a0,a5
    return (hash >> (32 - bits));
ffffffffc020616a:	02000793          	li	a5,32
ffffffffc020616e:	40b785bb          	subw	a1,a5,a1
}
ffffffffc0206172:	00b5553b          	srlw	a0,a0,a1
...
ffffffffc020619a:	2a01                	sext.w	s4,s4
    ...
    if (num >= base) {
ffffffffc020619c:	03067e63          	bleu	a6,a2,ffffffffc02061d8 <printnum+0x60>
...
ffffffffc02061b6:	00003797          	auipc	a5,0x3
ffffffffc02061ba:	a8a78793          	addi	a5,a5,-1398 # ffffffffc0208c40 <error_string+0xc8>
...
ffffffffc02061ea:	e8d2                	sd	s4,80(sp)
ffffffffc02061ec:	e4d6                	sd	s5,72(sp)
ffffffffc02061ee:	e0da                	sd	s6,64(sp)
ffffffffc02061f0:	fc5e                	sd	s7,56(sp)
...
ffffffffc02061fa:	ecce                	sd	s3,88(sp)
...
ffffffffc0206206:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0206208:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020620a:	00003a17          	auipc	s4,0x3
ffffffffc020620e:	816a0a13          	addi	s4,s4,-2026 # ffffffffc0208a20 <syscalls+0x100>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206212:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0206216:	00003c17          	auipc	s8,0x3
ffffffffc020621a:	962c0c13          	addi	s8,s8,-1694 # ffffffffc0208b78 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020621e:	000d4503          	lbu	a0,0(s10)
ffffffffc0206222:	02500793          	li	a5,37
ffffffffc0206226:	001d0413          	addi	s0,s10,1
ffffffffc020622a:	00f50e63          	beq	a0,a5,ffffffffc0206246 <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc020622e:	c521                	beqz	a0,ffffffffc0206276 <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0206230:	02500993          	li	s3,37
ffffffffc0206234:	a011                	j	ffffffffc0206238 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0206236:	c121                	beqz	a0,ffffffffc0206276 <vprintfmt+0x92>
            putch(ch, putdat);
ffffffffc0206238:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020623a:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc020623c:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020623e:	fff44503          	lbu	a0,-1(s0)
ffffffffc0206242:	ff351ae3          	bne	a0,s3,ffffffffc0206236 <vprintfmt+0x52>
ffffffffc0206246:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc020624a:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc020624e:	4981                	li	s3,0
ffffffffc0206250:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0206252:	5cfd                	li	s9,-1
ffffffffc0206254:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206256:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc020625a:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020625c:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0206260:	0ff6f693          	andi	a3,a3,255
ffffffffc0206264:	00140d13          	addi	s10,s0,1
ffffffffc0206268:	20d5e563          	bltu	a1,a3,ffffffffc0206472 <vprintfmt+0x28e>
ffffffffc020626c:	068a                	slli	a3,a3,0x2
ffffffffc020626e:	96d2                	add	a3,a3,s4
ffffffffc0206270:	4294                	lw	a3,0(a3)
ffffffffc0206272:	96d2                	add	a3,a3,s4
ffffffffc0206274:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0206276:	70e6                	ld	ra,120(sp)
ffffffffc0206278:	7446                	ld	s0,112(sp)
ffffffffc020627a:	74a6                	ld	s1,104(sp)
ffffffffc020627c:	7906                	ld	s2,96(sp)
ffffffffc020627e:	69e6                	ld	s3,88(sp)
ffffffffc0206280:	6a46                	ld	s4,80(sp)
ffffffffc0206282:	6aa6                	ld	s5,72(sp)
ffffffffc0206284:	6b06                	ld	s6,64(sp)
ffffffffc0206286:	7be2                	ld	s7,56(sp)
ffffffffc0206288:	7c42                	ld	s8,48(sp)
ffffffffc020628a:	7ca2                	ld	s9,40(sp)
ffffffffc020628c:	7d02                	ld	s10,32(sp)
ffffffffc020628e:	6de2                	ld	s11,24(sp)
ffffffffc0206290:	6109                	addi	sp,sp,128
ffffffffc0206292:	8082                	ret
    if (lflag >= 2) {
ffffffffc0206294:	4705                	li	a4,1
ffffffffc0206296:	008a8593          	addi	a1,s5,8
ffffffffc020629a:	01074463          	blt	a4,a6,ffffffffc02062a2 <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc020629e:	26080363          	beqz	a6,ffffffffc0206504 <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc02062a2:	000ab603          	ld	a2,0(s5)
ffffffffc02062a6:	46c1                	li	a3,16
ffffffffc02062a8:	8aae                	mv	s5,a1
ffffffffc02062aa:	a06d                	j	ffffffffc0206354 <vprintfmt+0x170>
            goto reswitch;
ffffffffc02062ac:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc02062b0:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062b2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062b4:	b765                	j	ffffffffc020625c <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc02062b6:	000aa503          	lw	a0,0(s5)
ffffffffc02062ba:	85a6                	mv	a1,s1
ffffffffc02062bc:	0aa1                	addi	s5,s5,8
ffffffffc02062be:	9902                	jalr	s2
            break;
ffffffffc02062c0:	bfb9                	j	ffffffffc020621e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02062c2:	4705                	li	a4,1
ffffffffc02062c4:	008a8993          	addi	s3,s5,8
ffffffffc02062c8:	01074463          	blt	a4,a6,ffffffffc02062d0 <vprintfmt+0xec>
    else if (lflag) {
ffffffffc02062cc:	22080463          	beqz	a6,ffffffffc02064f4 <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc02062d0:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc02062d4:	24044463          	bltz	s0,ffffffffc020651c <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc02062d8:	8622                	mv	a2,s0
ffffffffc02062da:	8ace                	mv	s5,s3
ffffffffc02062dc:	46a9                	li	a3,10
ffffffffc02062de:	a89d                	j	ffffffffc0206354 <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc02062e0:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02062e4:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02062e6:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc02062e8:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02062ec:	8fb5                	xor	a5,a5,a3
ffffffffc02062ee:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02062f2:	1ad74363          	blt	a4,a3,ffffffffc0206498 <vprintfmt+0x2b4>
ffffffffc02062f6:	00369793          	slli	a5,a3,0x3
ffffffffc02062fa:	97e2                	add	a5,a5,s8
ffffffffc02062fc:	639c                	ld	a5,0(a5)
ffffffffc02062fe:	18078d63          	beqz	a5,ffffffffc0206498 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0206302:	86be                	mv	a3,a5
ffffffffc0206304:	00000617          	auipc	a2,0x0
ffffffffc0206308:	35c60613          	addi	a2,a2,860 # ffffffffc0206660 <etext+0x28>
ffffffffc020630c:	85a6                	mv	a1,s1
ffffffffc020630e:	854a                	mv	a0,s2
ffffffffc0206310:	240000ef          	jal	ra,ffffffffc0206550 <printfmt>
ffffffffc0206314:	b729                	j	ffffffffc020621e <vprintfmt+0x3a>
            lflag ++;
ffffffffc0206316:	00144603          	lbu	a2,1(s0)
ffffffffc020631a:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020631c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020631e:	bf3d                	j	ffffffffc020625c <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0206320:	4705                	li	a4,1
ffffffffc0206322:	008a8593          	addi	a1,s5,8
ffffffffc0206326:	01074463          	blt	a4,a6,ffffffffc020632e <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc020632a:	1e080263          	beqz	a6,ffffffffc020650e <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc020632e:	000ab603          	ld	a2,0(s5)
ffffffffc0206332:	46a1                	li	a3,8
ffffffffc0206334:	8aae                	mv	s5,a1
ffffffffc0206336:	a839                	j	ffffffffc0206354 <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0206338:	03000513          	li	a0,48
ffffffffc020633c:	85a6                	mv	a1,s1
ffffffffc020633e:	e03e                	sd	a5,0(sp)
ffffffffc0206340:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0206342:	85a6                	mv	a1,s1
ffffffffc0206344:	07800513          	li	a0,120
ffffffffc0206348:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020634a:	0aa1                	addi	s5,s5,8
ffffffffc020634c:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0206350:	6782                	ld	a5,0(sp)
ffffffffc0206352:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0206354:	876e                	mv	a4,s11
ffffffffc0206356:	85a6                	mv	a1,s1
ffffffffc0206358:	854a                	mv	a0,s2
ffffffffc020635a:	e1fff0ef          	jal	ra,ffffffffc0206178 <printnum>
            break;
ffffffffc020635e:	b5c1                	j	ffffffffc020621e <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0206360:	000ab603          	ld	a2,0(s5)
ffffffffc0206364:	0aa1                	addi	s5,s5,8
ffffffffc0206366:	1c060663          	beqz	a2,ffffffffc0206532 <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc020636a:	00160413          	addi	s0,a2,1
ffffffffc020636e:	17b05c63          	blez	s11,ffffffffc02064e6 <vprintfmt+0x302>
ffffffffc0206372:	02d00593          	li	a1,45
ffffffffc0206376:	14b79263          	bne	a5,a1,ffffffffc02064ba <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020637a:	00064783          	lbu	a5,0(a2)
ffffffffc020637e:	0007851b          	sext.w	a0,a5
ffffffffc0206382:	c905                	beqz	a0,ffffffffc02063b2 <vprintfmt+0x1ce>
ffffffffc0206384:	000cc563          	bltz	s9,ffffffffc020638e <vprintfmt+0x1aa>
ffffffffc0206388:	3cfd                	addiw	s9,s9,-1
ffffffffc020638a:	036c8263          	beq	s9,s6,ffffffffc02063ae <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc020638e:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206390:	18098463          	beqz	s3,ffffffffc0206518 <vprintfmt+0x334>
ffffffffc0206394:	3781                	addiw	a5,a5,-32
ffffffffc0206396:	18fbf163          	bleu	a5,s7,ffffffffc0206518 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc020639a:	03f00513          	li	a0,63
ffffffffc020639e:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063a0:	0405                	addi	s0,s0,1
ffffffffc02063a2:	fff44783          	lbu	a5,-1(s0)
ffffffffc02063a6:	3dfd                	addiw	s11,s11,-1
ffffffffc02063a8:	0007851b          	sext.w	a0,a5
ffffffffc02063ac:	fd61                	bnez	a0,ffffffffc0206384 <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc02063ae:	e7b058e3          	blez	s11,ffffffffc020621e <vprintfmt+0x3a>
...
ffffffffc02063ba:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02063bc:	e60d81e3          	beqz	s11,ffffffffc020621e <vprintfmt+0x3a>
ffffffffc02063c0:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02063c2:	85a6                	mv	a1,s1
ffffffffc02063c4:	02000513          	li	a0,32
ffffffffc02063c8:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02063ca:	fe0d94e3          	bnez	s11,ffffffffc02063b2 <vprintfmt+0x1ce>
ffffffffc02063ce:	bd81                	j	ffffffffc020621e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02063d0:	4705                	li	a4,1
ffffffffc02063d2:	008a8593          	addi	a1,s5,8
ffffffffc02063d6:	01074463          	blt	a4,a6,ffffffffc02063de <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc02063da:	12080063          	beqz	a6,ffffffffc02064fa <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc02063de:	000ab603          	ld	a2,0(s5)
ffffffffc02063e2:	46a9                	li	a3,10
ffffffffc02063e4:	8aae                	mv	s5,a1
ffffffffc02063e6:	b7bd                	j	ffffffffc0206354 <vprintfmt+0x170>
ffffffffc02063e8:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc02063ec:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02063f0:	846a                	mv	s0,s10
ffffffffc02063f2:	b5ad                	j	ffffffffc020625c <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc02063f4:	85a6                	mv	a1,s1
ffffffffc02063f6:	02500513          	li	a0,37
ffffffffc02063fa:	9902                	jalr	s2
            break;
ffffffffc02063fc:	b50d                	j	ffffffffc020621e <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc02063fe:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc0206402:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0206406:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206408:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc020640a:	e40dd9e3          	bgez	s11,ffffffffc020625c <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc020640e:	8de6                	mv	s11,s9
ffffffffc0206410:	5cfd                	li	s9,-1
ffffffffc0206412:	b5a9                	j	ffffffffc020625c <vprintfmt+0x78>
            goto reswitch;
ffffffffc0206414:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0206418:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020641c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020641e:	bd3d                	j	ffffffffc020625c <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc0206420:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
...
ffffffffc020642a:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc020642e:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206432:	fcd56ce3          	bltu	a0,a3,ffffffffc020640a <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0206436:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0206438:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc020643c:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0206440:	0196873b          	addw	a4,a3,s9
ffffffffc0206444:	0017171b          	slliw	a4,a4,0x1
ffffffffc0206448:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc020644c:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0206450:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0206454:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206458:	fcd57fe3          	bleu	a3,a0,ffffffffc0206436 <vprintfmt+0x252>
ffffffffc020645c:	b77d                	j	ffffffffc020640a <vprintfmt+0x226>
            if (width < 0)
ffffffffc020645e:	fffdc693          	not	a3,s11
ffffffffc0206462:	96fd                	srai	a3,a3,0x3f
ffffffffc0206464:	00ddfdb3          	and	s11,s11,a3
ffffffffc0206468:	00144603          	lbu	a2,1(s0)
ffffffffc020646c:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020646e:	846a                	mv	s0,s10
ffffffffc0206470:	b3f5                	j	ffffffffc020625c <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc0206472:	85a6                	mv	a1,s1
ffffffffc0206474:	02500513          	li	a0,37
ffffffffc0206478:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020647a:	fff44703          	lbu	a4,-1(s0)
ffffffffc020647e:	02500793          	li	a5,37
ffffffffc0206482:	8d22                	mv	s10,s0
ffffffffc0206484:	d8f70de3          	beq	a4,a5,ffffffffc020621e <vprintfmt+0x3a>
ffffffffc0206488:	02500713          	li	a4,37
ffffffffc020648c:	1d7d                	addi	s10,s10,-1
ffffffffc020648e:	fffd4783          	lbu	a5,-1(s10)
ffffffffc0206492:	fee79de3          	bne	a5,a4,ffffffffc020648c <vprintfmt+0x2a8>
ffffffffc0206496:	b361                	j	ffffffffc020621e <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0206498:	00003617          	auipc	a2,0x3
ffffffffc020649c:	88860613          	addi	a2,a2,-1912 # ffffffffc0208d20 <error_string+0x1a8>
ffffffffc02064a0:	85a6                	mv	a1,s1
ffffffffc02064a2:	854a                	mv	a0,s2
ffffffffc02064a4:	0ac000ef          	jal	ra,ffffffffc0206550 <printfmt>
ffffffffc02064a8:	bb9d                	j	ffffffffc020621e <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02064aa:	00003617          	auipc	a2,0x3
ffffffffc02064ae:	86e60613          	addi	a2,a2,-1938 # ffffffffc0208d18 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
ffffffffc02064b2:	00003417          	auipc	s0,0x3
ffffffffc02064b6:	86740413          	addi	s0,s0,-1945 # ffffffffc0208d19 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02064ba:	8532                	mv	a0,a2
ffffffffc02064bc:	85e6                	mv	a1,s9
ffffffffc02064be:	e032                	sd	a2,0(sp)
ffffffffc02064c0:	e43e                	sd	a5,8(sp)
ffffffffc02064c2:	0cc000ef          	jal	ra,ffffffffc020658e <strnlen>
ffffffffc02064c6:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02064ca:	6602                	ld	a2,0(sp)
ffffffffc02064cc:	01b05d63          	blez	s11,ffffffffc02064e6 <vprintfmt+0x302>
ffffffffc02064d0:	67a2                	ld	a5,8(sp)
ffffffffc02064d2:	2781                	sext.w	a5,a5
ffffffffc02064d4:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc02064d6:	6522                	ld	a0,8(sp)
ffffffffc02064d8:	85a6                	mv	a1,s1
ffffffffc02064da:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02064dc:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02064de:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02064e0:	6602                	ld	a2,0(sp)
ffffffffc02064e2:	fe0d9ae3          	bnez	s11,ffffffffc02064d6 <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02064e6:	00064783          	lbu	a5,0(a2)
ffffffffc02064ea:	0007851b          	sext.w	a0,a5
ffffffffc02064ee:	e8051be3          	bnez	a0,ffffffffc0206384 <vprintfmt+0x1a0>
ffffffffc02064f2:	b335                	j	ffffffffc020621e <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc02064f4:	000aa403          	lw	s0,0(s5)
ffffffffc02064f8:	bbf1                	j	ffffffffc02062d4 <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc02064fa:	000ae603          	lwu	a2,0(s5)
ffffffffc02064fe:	46a9                	li	a3,10
ffffffffc0206500:	8aae                	mv	s5,a1
ffffffffc0206502:	bd89                	j	ffffffffc0206354 <vprintfmt+0x170>
ffffffffc0206504:	000ae603          	lwu	a2,0(s5)
ffffffffc0206508:	46c1                	li	a3,16
ffffffffc020650a:	8aae                	mv	s5,a1
ffffffffc020650c:	b5a1                	j	ffffffffc0206354 <vprintfmt+0x170>
ffffffffc020650e:	000ae603          	lwu	a2,0(s5)
ffffffffc0206512:	46a1                	li	a3,8
ffffffffc0206514:	8aae                	mv	s5,a1
ffffffffc0206516:	bd3d                	j	ffffffffc0206354 <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc0206518:	9902                	jalr	s2
ffffffffc020651a:	b559                	j	ffffffffc02063a0 <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc020651c:	85a6                	mv	a1,s1
ffffffffc020651e:	02d00513          	li	a0,45
ffffffffc0206522:	e03e                	sd	a5,0(sp)
ffffffffc0206524:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0206526:	8ace                	mv	s5,s3
ffffffffc0206528:	40800633          	neg	a2,s0
ffffffffc020652c:	46a9                	li	a3,10
ffffffffc020652e:	6782                	ld	a5,0(sp)
ffffffffc0206530:	b515                	j	ffffffffc0206354 <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc0206532:	01b05663          	blez	s11,ffffffffc020653e <vprintfmt+0x35a>
ffffffffc0206536:	02d00693          	li	a3,45
ffffffffc020653a:	f6d798e3          	bne	a5,a3,ffffffffc02064aa <vprintfmt+0x2c6>
ffffffffc020653e:	00002417          	auipc	s0,0x2
ffffffffc0206542:	7db40413          	addi	s0,s0,2011 # ffffffffc0208d19 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206546:	02800513          	li	a0,40
ffffffffc020654a:	02800793          	li	a5,40
ffffffffc020654e:	bd1d                	j	ffffffffc0206384 <vprintfmt+0x1a0>

ffffffffc0206550 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206550:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0206552:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206556:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0206558:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020655a:	ec06                	sd	ra,24(sp)
ffffffffc020655c:	f83a                	sd	a4,48(sp)
ffffffffc020655e:	fc3e                	sd	a5,56(sp)
ffffffffc0206560:	e0c2                	sd	a6,64(sp)
ffffffffc0206562:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0206564:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0206566:	c7fff0ef          	jal	ra,ffffffffc02061e4 <vprintfmt>
}
ffffffffc020656a:	60e2                	ld	ra,24(sp)
ffffffffc020656c:	6161                	addi	sp,sp,80
ffffffffc020656e:	8082                	ret

ffffffffc0206570 <strlen>:
...
ffffffffc0206574:	cb91                	beqz	a5,ffffffffc0206588 <strlen+0x18>
    size_t cnt = 0;
...
ffffffffc0206582:	fb7d                	bnez	a4,ffffffffc0206578 <strlen+0x8>
    }
    return cnt;
}
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc020658e:	c185                	beqz	a1,ffffffffc02065ae <strnlen+0x20>
ffffffffc0206590:	00054783          	lbu	a5,0(a0)
ffffffffc0206594:	cf89                	beqz	a5,ffffffffc02065ae <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0206596:	4781                	li	a5,0
ffffffffc0206598:	a021                	j	ffffffffc02065a0 <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc020659a:	00074703          	lbu	a4,0(a4)
ffffffffc020659e:	c711                	beqz	a4,ffffffffc02065aa <strnlen+0x1c>
        cnt ++;
ffffffffc02065a0:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc02065a2:	00f50733          	add	a4,a0,a5
ffffffffc02065a6:	fef59ae3          	bne	a1,a5,ffffffffc020659a <strnlen+0xc>
    }
    return cnt;
}
...
ffffffffc02065b8:	fff5c703          	lbu	a4,-1(a1)
ffffffffc02065bc:	0785                	addi	a5,a5,1
ffffffffc02065be:	fee78fa3          	sb	a4,-1(a5)
ffffffffc02065c2:	fb75                	bnez	a4,ffffffffc02065b6 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc02065ce:	cb91                	beqz	a5,ffffffffc02065e2 <strcmp+0x1c>
ffffffffc02065d0:	00e79c63          	bne	a5,a4,ffffffffc02065e8 <strcmp+0x22>
        s1 ++, s2 ++;
ffffffffc02065d4:	0505                	addi	a0,a0,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02065d6:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
ffffffffc02065da:	0585                	addi	a1,a1,1
ffffffffc02065dc:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02065e0:	fbe5                	bnez	a5,ffffffffc02065d0 <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02065e2:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc02065e4:	9d19                	subw	a0,a0,a4
ffffffffc02065e6:	8082                	ret
ffffffffc02065e8:	0007851b          	sext.w	a0,a5
ffffffffc02065ec:	9d19                	subw	a0,a0,a4
ffffffffc02065ee:	8082                	ret

ffffffffc02065f0 <strchr>:
...
ffffffffc02065f4:	cb91                	beqz	a5,ffffffffc0206608 <strchr+0x18>
        if (*s == c) {
ffffffffc02065f6:	00b79563          	bne	a5,a1,ffffffffc0206600 <strchr+0x10>
ffffffffc02065fa:	a809                	j	ffffffffc020660c <strchr+0x1c>
ffffffffc02065fc:	00b78763          	beq	a5,a1,ffffffffc020660a <strchr+0x1a>
            return (char *)s;
        }
        s ++;
ffffffffc0206600:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0206602:	00054783          	lbu	a5,0(a0)
ffffffffc0206606:	fbfd                	bnez	a5,ffffffffc02065fc <strchr+0xc>
    }
    return NULL;
ffffffffc0206608:	4501                	li	a0,0
}
ffffffffc020660a:	8082                	ret
ffffffffc020660c:	8082                	ret

ffffffffc020660e <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc020660e:	ca01                	beqz	a2,ffffffffc020661e <memset+0x10>
ffffffffc0206610:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0206612:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0206614:	0785                	addi	a5,a5,1
ffffffffc0206616:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020661a:	fec79de3          	bne	a5,a2,ffffffffc0206614 <memset+0x6>
    }
    return s;
...
ffffffffc0206620 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0206620:	ca19                	beqz	a2,ffffffffc0206636 <memcpy+0x16>
ffffffffc0206622:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0206624:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0206626:	0585                	addi	a1,a1,1
ffffffffc0206628:	fff5c703          	lbu	a4,-1(a1)
ffffffffc020662c:	0785                	addi	a5,a5,1
ffffffffc020662e:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0206632:	fec59ae3          	bne	a1,a2,ffffffffc0206626 <memcpy+0x6>
    }
    return dst;
